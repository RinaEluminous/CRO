    ...
    function addCustSubMenuForShopOrder() {
      var custHTML = '' +
        ...
        '                  </li>' +
        '                  <li>' +
        '                      <a href="https://www.mirrormate.com/collections/silver-grey"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/silver-home2.png"><span>Shop Silver</span></a>' +
        '                  </li>' +
        '                  <li>' +
