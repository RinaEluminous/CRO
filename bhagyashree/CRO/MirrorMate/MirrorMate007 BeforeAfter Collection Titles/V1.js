    		...
    		var intPlpInterval = setInterval(function (){
    			...
    			if( jQuery('.collection .products.products-grid div.spf-col-6').length > 0) {
		    		...
		    		if( jQuery('.collection .products.products-grid div.spf-col-6').length > 9 && jQuery('.custSecondTestimonial').length == 0 ){
		    			jQuery('<div class="spf-col-xl-4 spf-col-lg-4 spf-col-md-6 spf-col-sm-12 spf-col-6 custFeedbackSection"><div class="custReviewFeedbackBox custSecondTestimonial"><div class="custStartImg"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/rating-stars.svg"></div><h5>Easy to assemble.</h5><p>Love the dove tail connectors at the corners which keeps the joints tight. Peal and stick and you\'re done.</p><span>– Henry D.</span></div></div>').insertAfter('.products.products-grid div.spf-col-6:eq(8)');
		    		}
    			}
