window.MirrorMate012String2Mob = ''+ 
'      <div class="custMostPopulerColorHpMob custCommonHeadingHpMob">'+ 
'          <h2>Shop Our Most Popular Colors</h2>'+ 
'          <p>Custom-made frame kits guaranteed to fit any mirror.</p>'+ 
'          <div class="custSlickColorSliderHpMob">'+ 
'              <div class="custSlickSliderWrapperHpMob">'+ 
'                  <div class="custMostPopulerColorHpMobSlider">'+ 
'                      <div class="custColorSlide">'+ 
'                          <div class="custColorFrameBoxWrapperHpMob">'+ 
...
'                      </div>'+ 
'                  </div>'+ 
'              </div><a href="https://www.mirrormate.com/collections/all-frames" class="customBlueButtonHpMob">SHOP POPULAR FRAMES</a></div>'+ 
'      </div>'+ 
'      <div class="custSeeForYourselfHpMob custCommonHeadingHpMob">'+ 
'          <div class="custcol6"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/mirror_frame_block.png"></div>'+ 
'          <div class="custcol6">'+ 
'              <h2>See For Yourself</h2>'+ 
'              <p>Grab your samples so you can see what frames styles work best in your space</p><a href="https://www.mirrormate.com/collections/samples" class="customBlueButtonHpMob">ORDER $2 SAMPLES</a></div>'+ 
'      </div>'+ 
'      <div class="custRealCustomersSectionHpMob custCommonHeadingHpMob">'+ 
'          <h2>Real Customers Make MirrorMate Look Easy</h2>'+ 
'          <div class="custMainVideoBlockHpMob">'+ 
'              <div>'+ 
...
'          </div>'+ 
'      </div>'+ 
'      <div class="custFAQBlockHpMob">'+ 
'          <div class="custFAQwrapperHpMob">'+ 
'              <h2>Frequently Asked Questions</h2><label class="custAccordionHpMob"><input type="checkbox" name="checkbox-accordion" checked="checked"><div class="custAccordionHeaderHpMob">Can I order samples?</div><div class="custAccordionContentHpMob"><p>We encourage you to order samples to see how the frame looks in your bathroom. Samples can be ordered <strong><a href="/collections/samples" class="a-1" title="Here">here</a></strong>.</p></div></label>'+ 
'              <label'+ 
'                  class="custAccordionHpMob"><input type="checkbox" name="checkbox-accordion">'+ 
'                  <div class="custAccordionHeaderHpMob">How does the product work?</div>'+ 
'                  <div class="custAccordionContentHpMob">'+ 
...
'                  </div>'+ 
'                  </label><label class="custAccordionHpMob"><input type="checkbox" name="checkbox-accordion"><div class="custAccordionHeaderHpMob">How does the frame attach to the mirror?</div><div class="custAccordionContentHpMob"><p>The frame is pre-taped with professional-grade 3M tape and guaranteed to last in the bath.</p></div></label>'+ 
'                  <label'+ 
'                      class="custAccordionHpMob"><input type="checkbox" name="checkbox-accordion">'+ 
'                      <div class="custAccordionHeaderHpMob">What is the frame made of?</div>'+ 
'                      <div class="custAccordionContentHpMob">'+ 
...
'                          </div>'+ 
'                          </label><label class="custAccordionHpMob"><input type="checkbox" name="checkbox-accordion"><div class="custAccordionHeaderHpMob">Do you sell mirror too?</div><div class="custAccordionContentHpMob"><p>No. Our frames are for pre-existing, wall-mounted mirrors.</p></div></label>'+ 
'                          <label'+ 
'                              class="custAccordionHpMob"><input type="checkbox" name="checkbox-accordion">'+ 
'                              <div class="custAccordionHeaderHpMob">Do you sell frames for oval mirrors?</div>'+ 
'                              <div class="custAccordionContentHpMob">'+ 
