...
window.MirrorMate012String1Mob = ''+
'      <div class="custMirrorMateBannerHpMob">'+ 
'          <div class="custBannerFullBgHpMob">'+ 
'              <div class="container">'+ 
'                  <div class="custLeftBannerContentHpMob">'+ 
'                      <ul>'+ 
...
'                      </ul>'+ 
'                      <div class="custReviewContentHpMob"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/rating-stars.svg"><span class="custStarReviewsContent">Over 4,716 5-star reviews</span></div>'+ 
'                      <h3>Frame Your Bare Mirror</h3>'+ 
'                      <p>Add a beautiful finish to your existing mirror with an easy-install frame kit.</p>'+ 
'                      <div class="customButtonGroupHpMob"><a href="'+strLink+'" class="customBlueButtonHpMob">SHOP FRAME KITS</a><a href="https://www.mirrormate.com/collections/samples" class="customBlueButtonHpMob">SHOP SAMPLES</a></div>'+ 
'                  </div>'+ 
'                  <div class="custRightBannerImgHpMob"><div class="custHowItWorksVideoPopupHpMob"><video loop="loop" autoplay="autoplay" id="custHowItWorkVideo" muted defaultMuted playsinline preload="auto" ><source src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/backsplash_video.mp4" type="video/mp4"></video><button type="button" id="custPlayButton"></button></div>'+ 
'                      </div>'+ 
'                  </div>'+ 
'              </div>'+ 
'          </div>'+ 
'          <div class="container">'+ 
'              <div class="row">'+ 
'                  <div class="custAsSeenLogosBlockHpMob">'+ 
'                      <ul>'+ 
...
'                      </ul>'+ 
'                  </div>'+ 
'                  <div class="custWorksOnAnyMirrorHpMob">'+ 
'                      <ul>'+ 
'                          <li>'+ 
'                              <h2>Works On Any Mirror!</h2>'+ 
'                          </li>'+ 
'                          <li><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/backsplash_wall.png" class="custDImageHpMob"> <img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/backsplash_wall_mob.png" class="custMImageHpMob"><a href="https://www.mirrormate.com/pages/faq"><span><img src="https://cdn.shopify.com/s/files/1/0350/5894/1996/files/Green_Check_Mark_copy.png?v=1615206046"/></span>Mirror against backsplash or wall</a></li>'+ 
'                          <li><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/mirro_with_clip.png" class="custDImageHpMob"> <img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/mirro_with_clip_mob.png" class="custMImageHpMob"><a href="https://www.mirrormate.com/pages/faq"><span><img src="https://cdn.shopify.com/s/files/1/0350/5894/1996/files/Green_Check_Mark_copy.png?v=1615206046"/></span>Mirror with clips</a></li>'+ 
'                      </ul>'+ 
'                  </div>'+ 
'              </div>'+ 
'          </div>'+ 
'      </div>'+ 
'      <div class="custHowItsWorkVideoBlockHpMob custCommonHeadingHpMob">'+ 
'          <div class="container">'+ 
'              <div class="row">'+ 
'                  <div class="col-md-6">'+ 
'                      <div><div class="custRightBannerImgHpMob"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/mob_hero_section_018.jpg">'+ 
'                      <div class="custBannerReviewQuotesHpMob"><span>"Completely transformed our bathroom, was super easy to install!"<strong>─ KRISTY C.</strong></span>'+ 
'                          <ul>'+ 
...
'                      </ul>'+ 
'                      <div class="customButtonGroupHpMob"><a href="'+strLink+'" class="customBlueButtonHpMob">SHOP FRAME KITS</a><a href="https://www.mirrormate.com/pages/how-it-works" class="customBlueButtonHpMob">SEE ALL STEPS <img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/np_arrow-right.svg"></a></div>'+ 
'                  </div>'+ 
'              </div>'+ 
'          </div>'+ 
'      </div>'+ 
'      <div class="custGuaranteeWrapperBlockHpMob">'+ 
'          <div class="container custWhiteBgHpMob">'+ 
'              <div class="custGuaranteeTitleHpMob"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/guarantee.svg">No Worries Guarantee</div>'+ 
'              <ul>'+ 
...
'              </ul>'+ 
'          </div>'+ 
'          <div class="custFramesSoldBlockHpMob custCommonHeadingHpMob">'+ 
'              <h2>Over 450,000 Frames Sold</h2>'+ 
'              <div class="custClientReviewSliderHpMob">'+ 
'                  <div>'+ 
'                      <div class="custReviewWrapperHpMob">'+ 
'                          <div class="custMegaReviewHpMob"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/rating-stars.svg">'+ 
