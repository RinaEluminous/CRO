...
'                  </div>'+ 
'                  <div class="custRightBannerImgHp"><div class="custHowItWorksVideoPopupHp"><video loop="true" autoplay="autoplay" id="custHowItWorkVideo" muted="" playsinline=""><source src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/backsplash_video.mp4" type="video/mp4"></video><button type="button" id="custPlayButton"></button></div>'+ 
'                      </div>'+ 
'                  </div>'+ 
'              </div>'+ 
'          </div>'+ 
