window.MirrorMateString2DeskCtrl = ''+ 
'      <div class="custMostPopulerColorCtrl custCommonHeadingCtrl">'+ 
'          <h2>Shop Our Most Popular Colors</h2>'+ 
'          <p>Custom-made frame kits guaranteed to fit any mirror.</p>'+ 
'          <div class="custSlickColorSliderCtrl">'+ 
'              <div class="custSlickSliderWrapperCtrl">'+ 
'                  <div class="custMostPopularColorSliderCtrl">'+ 
'                      <div class="custColorSlideCtrl">'+ 
'                          <div class="custColorFrameBoxWrapperCtrl">'+ 
...
'                      </div>'+ 
'                  </div>'+ 
'              </div><a href="https://www.mirrormate.com/collections/all-frames" class="custBlueButtonCtrl">SHOP POPULAR FRAMES</a></div>'+ 
'      </div>'+ 
'      <div class="custSeeForYourselfCtrl custCommonHeadingCtrl">'+ 
'          <div class="custcol6"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/mirror_frame_block.png"></div>'+ 
'          <div class="custcol6">'+ 
'              <h2>See For Yourself</h2>'+ 
'              <p>Grab your samples so you can see what frames styles work best in your space</p><a href="https://www.mirrormate.com/collections/samples" class="custBlueButtonCtrl">ORDER $2 SAMPLES</a></div>'+ 
'      </div>'+ 
'      <div class="custRealCustomersSectionCtrl custCommonHeadingCtrl">'+ 
'          <h2>Real Customers Make MirrorMate Look Easy</h2>'+ 
'          <div class="custMainVideoBlock">'+ 
'              <div>'+ 
'                  <div class="custVideoBlockCtrl"><iframe loading="lazy" src="https://fast.wistia.net/embed/iframe/lmnkhocyr7" title="CherokeeBarnwoodbyBrittanysHomeSweetHome Video" allow="autoplay; fullscreen" allowtransparency="true" frameborder="0" scrolling="no" class="wistia_embed"'+ 
'                          name="wistia_embed" msallowfullscreen="" width="640" height="640"></iframe></div>'+ 
'              </div>'+ 
'              <div>'+ 
'                  <div class="custVideoBlockCtrl"><iframe loading="lazy" src="https://fast.wistia.net/embed/iframe/0iaipqm5ea" title="CherokeeBarnwoodbyDanielleNicoleHome Video" allow="autoplay; fullscreen" allowtransparency="true" frameborder="0" scrolling="no" class="wistia_embed" name="wistia_embed"'+ 
'                          msallowfullscreen="" width="640" height="640"></iframe></div>'+ 
'              </div>'+ 
'              <div>'+ 
'                  <div class="custVideoBlockCtrl"><iframe loading="lazy" src="https://fast.wistia.net/embed/iframe/jbbln3e9yo" title="CherokeeFarmhousebyLifestylewithKara Video" allow="autoplay; fullscreen" allowtransparency="true" frameborder="0" scrolling="no" class="wistia_embed" name="wistia_embed"'+ 
'                          msallowfullscreen="" width="640" height="640"></iframe></div>'+ 
'              </div>'+ 
'          </div>'+ 
'      </div>'+ 
'      <div class="custFAQBlockCtrl">'+ 
'          <div class="custFAQwrapperCtrl">'+ 
'              <h2>Frequently Asked Questions</h2><label class="custAccordionCtrl"><input type="checkbox" name="checkbox-accordion" checked="checked"><div class="custAccordionHeaderCtrl">Can I order samples?</div><div class="custAccordionCtrlContentCtrl"><p>We encourage you to order samples to see how the frame looks in your bathroom. Samples can be ordered <strong><a href="/collections/samples" class="a-1" title="Here">here</a></strong>.</p></div></label>'+ 
'              <label'+ 
'                  class="custAccordionCtrl"><input type="checkbox" name="checkbox-accordion">'+ 
'                  <div class="custAccordionHeaderCtrl">How does the product work?</div>'+ 
'                  <div class="custAccordionCtrlContentCtrl">'+ 
...
'                  </div>'+ 
'                  </label><label class="custAccordionCtrl"><input type="checkbox" name="checkbox-accordion"><div class="custAccordionHeaderCtrl">How does the frame attach to the mirror?</div><div class="custAccordionCtrlContentCtrl"><p>The frame is pre-taped with professional-grade 3M tape and guaranteed to last in the bath.</p></div></label>'+ 
'                  <label'+ 
'                      class="custAccordionCtrl"><input type="checkbox" name="checkbox-accordion">'+ 
'                      <div class="custAccordionHeaderCtrl">What is the frame made of?</div>'+ 
'                      <div class="custAccordionCtrlContentCtrl">'+ 
...
'                          </div>'+ 
'                          </label><label class="custAccordionCtrl"><input type="checkbox" name="checkbox-accordion"><div class="custAccordionHeaderCtrl">Do you sell mirror too?</div><div class="custAccordionCtrlContentCtrl"><p>No. Our frames are for pre-existing, wall-mounted mirrors.</p></div></label>'+ 
'                          <label'+ 
'                              class="custAccordionCtrl"><input type="checkbox" name="checkbox-accordion">'+ 
'                              <div class="custAccordionHeaderCtrl">Do you sell frames for oval mirrors?</div>'+ 
'                              <div class="custAccordionCtrlContentCtrl">'+ 
