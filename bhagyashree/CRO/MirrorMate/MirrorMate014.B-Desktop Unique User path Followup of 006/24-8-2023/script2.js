...
'      <div class="custMirrorMateBannerHp">'+ 
'          <div class="custBannerFullBgHp">'+ 
'              <div class="container">'+ 
'                  <div class="custLeftBannerContentHp">'+ 
'                      <ul>'+ 
...
'                      </ul>'+ 
'                      <div class="custReviewContentHp"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/rating-stars.svg"><span class="custStarReviewsContent">Over 4,716 5-star reviews</span></div>'+ 
'                      <h3>Frame Your Bare Mirror</h3>'+ 
'                      <p>Add a beautiful finish to your existing mirror with an easy-install frame kit.</p>'+ 
'                      <div class="customButtonGroupHp"><a href="https://www.mirrormate.com/collections/all-frames" class="customBlueButtonHp">SHOP FRAME KITS</a><a href="https://www.mirrormate.com/collections/samples" class="customBlueButtonHp">SHOP SAMPLES</a></div>'+ 
'                  </div>'+ 
'                  <div class="custRightBannerImgHp"><div class="custHowItWorksVideoPopupHp"><video poster="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/video-poster.png" id="custHowItWorkVideo" autoplay="true"><source src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/backsplash_video.mp4" type="video/mp4"></video><button type="button" id="custPlayButton"></button></div>'+ 
'                      </div>'+ 
'                  </div>'+ 
'              </div>'+ 
'          </div>'+ 
'          <div class="container">'+ 
'              <div class="row">'+ 
'                  <div class="custAsSeenLogosBlockHp">'+ 
'                      <ul>'+ 
...
'                      </ul>'+ 
'                  </div>'+ 
'                  <div class="custWorksOnAnyMirrorHp">'+ 
'                      <ul>'+ 
'                          <li>'+ 
'                              <h2>Works On Any Mirror!</h2>'+ 
'                          </li>'+ 
'                          <li><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/backsplash_wall.png" class="custDImageHp"> <img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/backsplash_wall_mob.png" class="custMImageHp"><a href="https://www.mirrormate.com/pages/faq"><span><img src="https://cdn.shopify.com/s/files/1/0350/5894/1996/files/Green_Check_Mark_copy.png?v=1615206046"/></span>Mirror against backsplash or wall</a></li>'+ 
'                          <li><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/mirro_with_clip.png" class="custDImageHp"> <img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/mirro_with_clip_mob.png" class="custMImageHp"><a href="https://www.mirrormate.com/pages/faq"><span><img src="https://cdn.shopify.com/s/files/1/0350/5894/1996/files/Green_Check_Mark_copy.png?v=1615206046"/></span>Mirror with clips</a></li>'+ 
'                      </ul>'+ 
'                  </div>'+ 
'              </div>'+ 
'          </div>'+ 
'      </div>'+ 
'      <div class="custHowItsWorkVideoBlockHp custCommonHeadingHp">'+ 
'          <div class="container">'+ 
'              <div class="row">'+ 
'                  <div class="col-md-6">'+ 
'                      <div><div class="custRightBannerImgHp"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/mob_hero_section_018.jpg">'+ 
'                      <div class="custBannerReviewQuotesHp"><span>"Completely transformed our bathroom, was super easy to install!"<strong>─ KRISTY C.</strong></span>'+ 
'                          <ul>'+ 
...
'                      </ul>'+ 
'                      <div class="customButtonGroupHp"><a href="https://www.mirrormate.com/collections/all-frames" class="customBlueButtonHp">SHOP FRAME KITS</a><a href="https://www.mirrormate.com/pages/how-it-works" class="customBlueButtonHp">SEE ALL STEPS <img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/np_arrow-right.svg"></a></div>'+ 
'                  </div>'+ 
'              </div>'+ 
'          </div>'+ 
'      </div>'+ 
'      <div class="custGuaranteeWrapperBlockHp">'+ 
'          <div class="container custWhiteBgHp">'+ 
'              <div class="custGuaranteeTitleHp"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/guarantee.svg">No Worries Guarantee</div>'+ 
'              <ul>'+ 
...
'              </ul>'+ 
'          </div>'+ 
'          <div class="custFramesSoldBlockHp custCommonHeadingHp">'+ 
'              <h2>Over 450,000 Frames Sold</h2>'+ 
'              <div class="custClientReviewSliderHp">'+ 
'                  <div>'+ 
'                      <div class="custReviewWrapperHp">'+ 
'                          <div class="custMegaReviewHp"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/rating-stars.svg">'+ 
