...
'      <div class="custMostPopulerColorHp custCommonHeadingHp">'+ 
'          <h2>Shop Our Most Popular Colors</h2>'+ 
'          <p>Custom-made frame kits guaranteed to fit any mirror.</p>'+ 
'          <div class="custSlickColorSliderHp">'+ 
'              <div class="custSlickSliderWrapperHp">'+ 
'                  <div class="custMostPopulerColorHpSlider">'+ 
'                      <div class="custColorSlide">'+ 
'                          <div class="custColorFrameBoxWrapperHp">'+ 
...
'                      </div>'+ 
'                  </div>'+ 
'              </div><a href="https://www.mirrormate.com/collections/all-frames" class="customBlueButtonHp">SHOP POPULAR FRAMES</a></div>'+ 
'      </div>'+ 
'      <div class="custSeeForYourselfHp custCommonHeadingHp">'+ 
'          <div class="custcol6"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/mirrormate/mirror_frame_block.png"></div>'+ 
'          <div class="custcol6">'+ 
'              <h2>See For Yourself</h2>'+ 
'              <p>Grab your samples so you can see what frames styles work best in your space</p><a href="https://www.mirrormate.com/collections/samples" class="customBlueButtonHp">ORDER $2 SAMPLES</a></div>'+ 
'      </div>'+ 
'      <div class="custRealCustomersSectionHp custCommonHeadingHp">'+ 
'          <h2>Real Customers Make MirrorMate Look Easy</h2>'+ 
'          <div class="custMainVideoBlockHp">'+ 
'              <div>'+ 
...
'          </div>'+ 
'      </div>'+ 
'      <div class="custFAQBlockHp">'+ 
'          <div class="custFAQwrapperHp">'+ 
'              <h2>Frequently Asked Questions</h2><label class="custAccordionHp"><input type="checkbox" name="checkbox-accordion" checked="checked"><div class="custAccordionHeaderHp">Can I order samples?</div><div class="custAccordionContentHp"><p>We encourage you to order samples to see how the frame looks in your bathroom. Samples can be ordered <strong><a href="/collections/samples" class="a-1" title="Here">here</a></strong>.</p></div></label>'+ 
'              <label'+ 
'                  class="custAccordionHp"><input type="checkbox" name="checkbox-accordion">'+ 
'                  <div class="custAccordionHeaderHp">How does the product work?</div>'+ 
'                  <div class="custAccordionContentHp">'+ 
...
'                  </div>'+ 
'                  </label><label class="custAccordionHp"><input type="checkbox" name="checkbox-accordion"><div class="custAccordionHeaderHp">How does the frame attach to the mirror?</div><div class="custAccordionContentHp"><p>The frame is pre-taped with professional-grade 3M tape and guaranteed to last in the bath.</p></div></label>'+ 
'                  <label'+ 
'                      class="custAccordionHp"><input type="checkbox" name="checkbox-accordion">'+ 
'                      <div class="custAccordionHeaderHp">What is the frame made of?</div>'+ 
'                      <div class="custAccordionContentHp">'+ 
...
'                          </div>'+ 
'                          </label><label class="custAccordionHp"><input type="checkbox" name="checkbox-accordion"><div class="custAccordionHeaderHp">Do you sell mirror too?</div><div class="custAccordionContentHp"><p>No. Our frames are for pre-existing, wall-mounted mirrors.</p></div></label>'+ 
'                          <label'+ 
'                              class="custAccordionHp"><input type="checkbox" name="checkbox-accordion">'+ 
'                              <div class="custAccordionHeaderHp">Do you sell frames for oval mirrors?</div>'+ 
'                              <div class="custAccordionContentHp">'+ 
