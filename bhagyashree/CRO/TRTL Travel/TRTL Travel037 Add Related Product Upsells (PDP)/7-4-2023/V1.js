var waitForJquery = setInterval(function() { 
    ...
    //on 'add' CTA click of 'PACKING PODS', add this product to cart
    jQuery(document).on('click','.custAddToCard .custCardWrapper #custAddWrapBtn',function () {
          var intProductId = '42424489836737';
		  jQuery.get('https://trtltravel.com/products/trtl-packing-pods?variant='+intProductId+'&section_id=template--16140168528065__main', function(html) {
    ...
    function checkIsAvailable() {
    	...
    	jQuery.get('https://trtltravel.com/products/trtl-compression-socks?variant='+strSelectedProdId+'&section_id=template--16140168790209__main', function(html) {
