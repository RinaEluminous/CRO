var waitForjQuery = setInterval(function() {
    if (typeof jQuery != 'undefined') {
      ...
      //popup - email input on keyup
      jQuery(document).on("keyup",'.custClaimFreeWraper .custClaimFreePopup .content .formFeild input[type="email"]', function (){
        ...
        function validateEmail(){
            ...
            if( strEmail !== null && strEmail !== '' && strEmail !== undefined ) {
                if(IsEmail(strEmail) == false){
                  jQuery(".custError p").text("Please enter valid email address");
              ...
              jQuery(".custError p").text("Please enter email address");
              jQuery(".custError").css({'display': 'block'});
              return false;
          }
    }
