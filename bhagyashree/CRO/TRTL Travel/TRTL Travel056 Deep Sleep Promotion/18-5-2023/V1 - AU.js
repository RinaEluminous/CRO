var waitForjQuery = setInterval(function() {
    if (typeof jQuery != 'undefined') {
        ...
        var strUrl = "https://au.trtltravel.com/products/deep-sleep-bundle";
        ...
        function addCustProductBlockHp() {
            ...
            if (jQuery(window).width() <= 767) {
                ...
                if (jQuery('.section-banner-tiles-large-slider').length > 0) {
                    ...
                    jQuery('.section-banner-tiles-large-slider .custCoolPillow a').replaceWith('<div class="custProductListOffers"> <a href="' + strUrl + '" class="text-decoration-none"> <div class="tile-generic position-relative card h-100 text-center"> <span class="custLimitedOffer">Limited Time Offer</span> <div class="position-relative"> <div class="image-wrapper overflow-hidden "> <picture class="d-block"> <img src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/deep-sleep-bundle.jpg"> </picture> </div><div class="position-absolute bottom-0 start-50 translate-middle-x"> <span class="flashtag rounded-2 opacity-100 mb-3">SAVE 20%</span> </div></div><div class="card-body pb-0"> <div class="row g-0 justify-content-center align-items-center flex-nowrap px-2"> <div class="col-auto"> <h5 class="mb-0">Deep Sleep Bundle</h5> </div><div class="col-auto lh-80"> <i class="fa-solid fs-5 fa-arrow-right ms-2"></i> </div></div></div><div class="card-footer py-3"> <p class="text-grey fs-7 m-0">Great sleep and savings for all the family.</p></div></div></a></div>');
                }
            }
        }
