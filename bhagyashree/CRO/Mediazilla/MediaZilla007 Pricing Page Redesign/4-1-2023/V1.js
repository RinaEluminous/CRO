		...
		function addLinksToFeatureBlock() {
			...
			var interval = setInterval(function(){
                    ...
                    if(jQuery('.custInstitutionalPriceCarousel').length == 0){
                    	...
                    	if(jQuery('.price-card:contains(Pro) .pricing-list .pricing-item.title div').length > 0){
                    		jQuery('.price-card:contains(Pro) .pricing-list .pricing-item.title div').text('Includes:');
                    	}
