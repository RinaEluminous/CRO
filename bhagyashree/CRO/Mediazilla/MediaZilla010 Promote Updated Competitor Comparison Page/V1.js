var waitForjQuery = setInterval(function() {
	if (typeof jQuery != 'undefined') {
		console.log("%c MediaZilla010", "background:red;color : white;padding:10px");
		...
		console.log("Len >> "+ jQuery(".section .comparison-scroll .features-comparison-grid").length);
		...
		jQuery(document).on('click','.custCompetitorStickyBanner .closeBtn', function (){
