//function to call for home page only
if(jQuery('.hero-wrapper').length > 0){
	addCustomHTML();
	hideDefaultHtml();
}
...
jQuery(document).on('click', '.customHpBanner .custVideoWrapper .custVideoPlayButton,.custButtonWrapper a.custBtnV1.outlineBtn', function() {
