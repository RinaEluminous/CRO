function manageHpNewUserCustomBannerTop(){
    if(jQuery('#header').length > 0){
        var intHeaderHt = jQuery('#header').outerHeight();
        jQuery('.custHpNewHeroBanner').attr('style','margin-top:'+ intHeaderHt+'px');
    }
}
var intCount = 0;
...
function addCustHpHeroConditionHtml() {
    if(jQuery('.custHpNewEmuaidConditionWrapper').length == 0) {
        ...
        if( jQuery(window).width() <= 767 ){
            manageHpNewUserCustomBannerTop();
        }
