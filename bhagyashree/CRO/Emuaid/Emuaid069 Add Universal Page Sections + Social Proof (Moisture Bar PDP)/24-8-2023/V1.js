console.log("%c Emuaid069 ", "background:red;color : white;padding:10px");
	...
	function addSwiperSlider(){
		if(jQuery("#shopify-section-product-template .product__images").length  > 0 && jQuery("#shopify-section-product-template .custSwiperSlider").length == 0) {
            jQuery("#shopify-section-product-template .product__images").append('<div class="col-lg-6 product-left mb-5 mb-lg-0 custSwiperSlider"><div class="swiper-container mb-3 custProductSlider"><div class="swiper-wrapper"><div class="swiper-slide"><img src="https://drive.google.com/uc?id=1-qzpXz-6SaqM3IPlQl_d9YXaPaBPw1xi" alt="..." class="img-fluid"></div><div class="swiper-slide"><img src="https://drive.google.com/uc?id=1GyPJxF36hlp2JS7SeYrnW0Bmuc9KJyBq" alt="..." class="img-fluid"></div><div class="swiper-slide"><img src="https://drive.google.com/uc?id=1MIbogRkUdngQXnaXT8Mufup-7CScTNRj" alt="..." class="img-fluid"></div><div class="swiper-slide"><img src="https://drive.google.com/uc?id=1a_w8OcDV-IA5UMz7usKtO_lXf0YSee3u" alt="..." class="img-fluid"></div><div class="swiper-slide"><img src="https://drive.google.com/uc?id=1gLp3gryMbGYpgAfAtnDGccME1lCzEyUU" alt="..." class="img-fluid"></div><div class="swiper-slide"><img src="https://drive.google.com/uc?id=1iOOVa8mOrESI0o5o7au7nAOlPFAwbnLM" alt="..." class="img-fluid"></div></div><div class="swiper-button-next"></div><div class="swiper-button-prev"></div></div><div class="swiper-container custProductThumbs"><div class="swiper-wrapper"><div class="swiper-slide"><img src="https://drive.google.com/uc?id=1-qzpXz-6SaqM3IPlQl_d9YXaPaBPw1xi" alt="..." class="img-fluid"></div><div class="swiper-slide"><img src="https://drive.google.com/uc?id=1GyPJxF36hlp2JS7SeYrnW0Bmuc9KJyBq" alt="..." class="img-fluid"></div><div class="swiper-slide"><img src="https://drive.google.com/uc?id=1MIbogRkUdngQXnaXT8Mufup-7CScTNRj" alt="..." class="img-fluid"></div><div class="swiper-slide"><img src="https://drive.google.com/uc?id=1a_w8OcDV-IA5UMz7usKtO_lXf0YSee3u" alt="..." class="img-fluid"></div><div class="swiper-slide"><img src="https://drive.google.com/uc?id=1gLp3gryMbGYpgAfAtnDGccME1lCzEyUU" alt="..." class="img-fluid"></div><div class="swiper-slide"><img src="https://drive.google.com/uc?id=1iOOVa8mOrESI0o5o7au7nAOlPFAwbnLM" alt="..." class="img-fluid"></div></div></div></div>');
                if(jQuery("#shopify-section-product-template .product__images .custSwiperSlider").length  > 0){
                if (jQuery('.custSwiperSliderJS').length == 0) {
                    jQuery("head").append('<script src="https://unpkg.com/swiper@6.5.4/swiper-bundle.min.js" id="custSwiperSliderJS"></script>');
                    }

                if(jQuery('.custSwiperSliderCSS').length == 0){
                    jQuery( "head" ).append('<link rel="stylesheet" href="https://unpkg.com/swiper@6.5.4/swiper-bundle.min.css" id="custSwiperSliderCSS" />');
                }
                var intSwiperCnt = 0;
                var intSwiperInterval = setInterval(function () {
					...
					if (typeof Swiper !== 'undefined'){
						var productSlider = new Swiper('.custProductSlider', {
                            spaceBetween: 0,
                            centeredSlides: false,
                            loop:true,
                        ...
                        var productThumbs = new Swiper('.custProductThumbs', {
                            spaceBetween: 0,
                            centeredSlides: true,
                            loop: true,
                        ...
                        var intCount = 0;
                        var intWaitForImgInterval = setInterval(function () {
                            intCount += 1;
                        ...
                        if(intCount === 50){
                            clearInterval(intWaitForImgInterval);
                        }
						},70);
					}
