console.log("%c Emuaid069 ", "background:red;color : white;padding:10px");
	...
	function addSlickSlider(){
		if(jQuery("#shopify-section-product-template .product__images").length  > 0 && jQuery("#shopify-section-product-template .custSlickSlider").length == 0) {
			jQuery("#shopify-section-product-template .product__images").append('<div class="slider custSlickSlider"><div><img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/moisture-bar-image-02.jpg"></div><div><img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/moisture-bar-image-01.jpg"></div><div><img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/moisture-bar-image-04.jpg"></div><div><img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/moisture-bar-image-05.jpg"></div><div><img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/moisture-bar-image-06.jpg"></div><div><img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/moisture-bar-image-07.jpg"></div></div><div class="slider custProductThumbSlider"><div><img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/moisture-bar-image-02.jpg"></div><div><img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/moisture-bar-image-01.jpg"></div><div><img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/moisture-bar-image-04.jpg"></div><div><img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/moisture-bar-image-05.jpg"></div><div><img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/moisture-bar-image-06.jpg"></div><div><img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/moisture-bar-image-07.jpg"></div></div>');
			if(jQuery("#shopify-section-product-template .product__images .custSlickSlider").length  > 0){
		   
				if (jQuery('#custSlickJs').length == 0) {
				jQuery("head").append('<script src="https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js" id="custSlickJs"></script>');
				}

				if (jQuery('#custSlickCss').length == 0 && jQuery('#custSlickThemeCss').length == 0) {
				jQuery("head").append('<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css" id="custSlickCss"/>');
				jQuery("head").append('<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick-theme.css" id="custSlickThemeCss"/>');
			 ...
			 var intSlickInterval = setInterval(function () {
				   ...
				   if (typeof $.fn.slick !== 'undefined') {
								...
								jQuery('.custSlickSlider').not('.slick-initialized').slick({
									slidesToShow: 1,
									slidesToScroll: 1,
									arrows: true,
									fade: true,
									infinite: true,
									asNavFor: '.custProductThumbSlider' // Sync with the second slider
								});
								
								jQuery('.custProductThumbSlider').not('.slick-initialized').slick({
									slidesToShow: 6,
									slidesToScroll: 1,
									asNavFor: '.custSlickSlider', // Sync with the first slider
									focusOnSelect: true,
									infinite: true, 
								});
