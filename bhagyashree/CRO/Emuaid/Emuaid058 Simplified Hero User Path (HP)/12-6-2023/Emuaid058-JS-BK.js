    ...
    function addCustStickyFooter(){
        if(jQuery('.custNatureBannerInspired').length == 0){
            jQuery('<div class="custNatureBannerInspired"><div class="custMaximumStrengthBanner"><div class="custMaximumProductImg"><img src="https://cdn.shopify.com/s/files/1/0549/3181/6637/products/emuaidmax_0.5oz_front_E_b0247168-f184-40fe-9f32-6d6d42ab9380_2000x.jpg?v=1620715257"></div><div class="custMaximumProductText"><span>maximum strength</span><h3>EMUAIDMAXÂ® First Aid Ointment 0.5oz</h3></div><a href="https://www.emuaid.com/products/emuaidmax-first-aid-ointment-0-5oz">Shop EMUAIDMAX<small>Â®</small></a></div><div class="custMaximumStrengthBanner"><div class="custMaximumProductImg"><img src="https://cdn.shopify.com/s/files/1/0549/3181/6637/products/emuaid_0.5oz_front_E_96de6a22-25ea-4a27-8d57-112ba3ed34cb_2000x.jpg?v=1620715277"></div><div class="custMaximumProductText"><span>Regular Strength</span><h3>EMUAIDÂ® First Aid Ointment 0.5oz</h3></div><a href="https://www.emuaid.com/products/emuaid-first-aid-ointment-0-5oz">Shop EMUAID<small>Â®</small></a></div></div>').appendTo('.custNatureInspired');
        }
    }

    function elementInView(elem){
      var elementTop = jQuery(elem).offset().top;
      var elementBottom = (elementTop*2)+ jQuery(elem).outerHeight();
    ...
    jQuery(window).scroll(function() {
        if (elementInView(jQuery('.custNatureInspired .container'))){
            jQuery('.custNatureBannerInspired').addClass('custNatureBannerActive');
            jQuery('#userwayAccessibilityIcon').addClass('custHideIcon');
            jQuery('iframe#chat-button').addClass('custHideIcons');
        }  
        else{
            jQuery('.custNatureBannerInspired').removeClass('custNatureBannerActive');
            jQuery('#userwayAccessibilityIcon').removeClass('custHideIcon');
            jQuery('iframe#chat-button').removeClass('custHideIcons');
        }  
    });
