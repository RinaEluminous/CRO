...
function addCustNewVideoToToeNailFungusLpV2(){
	if(jQuery('#s-d4f4d888-0570-4ed8-b560-d86c77cac3ed').length > 0){
		jQuery('#s-d4f4d888-0570-4ed8-b560-d86c77cac3ed').addClass('custMainLpV2');
	}
	...
	if(jQuery('#s-f1f96b71-cb04-4df7-8a28-84c17b39e931 .bm-product').length > 0){
		jQuery('#s-f1f96b71-cb04-4df7-8a28-84c17b39e931 .bm-product').addClass('custProductClick');
	}
    if(jQuery('.custVideoText').length > 0 && jQuery('.custEmuaidVideoLpV2').length == 0 && jQuery('.custReviewLpV2').length == 0){
