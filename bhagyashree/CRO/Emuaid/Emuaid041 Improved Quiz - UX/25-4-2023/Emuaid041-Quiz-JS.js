        ...
        jQuery(document).on('click', ".custMainQuizPopup .popupContainer .prodListings ul li button:not('.custNextCTA')", function(){
            ...
            if(strProdType == 'regular'){
                ...
                strFeatures  = '<li>A perfect complement to EMUAIDÂ® First Aid Ointment, EMUAIDÂ® Therapeutic Moisture Bar deeply cleanses and detoxifies the skin, delivers intense hydration and restores moisture, exfoliates to promote cellular turnover and stimulates natural skin regeneration.</li><li>Use on face and body - excellent for shaving or shampoo.</li><li>No parabens, phthalates, paraffin, gluten, propylene glycol, mineral oil, synthetic fragrance, PABA, synthetic color, DEA or sulfates.</li>';
