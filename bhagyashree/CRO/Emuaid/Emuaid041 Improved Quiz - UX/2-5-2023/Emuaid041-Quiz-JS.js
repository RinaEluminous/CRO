        ...
        // Skip functionality to skip the discount step and move to next step
        jQuery(document).on('click', '.custMainQuizPopup #ProductSelectionQuiz .custBottomNavigation button.btn-skip', function(){
            ...
            setProdSizeData(strProdTypeAttr);
            jQuery('.custMainQuizPopup .popupContainer p.custBlueTag').hide();
            isDiscountSkip = 1;
        });

        // Back functionality for Step-2 and Step-3
        jQuery(document).on('click', '.custMainQuizPopup #ProductSelectionQuiz button.btn-back', function(){
        ...
        jQuery(document).on('click', ".custMainQuizPopup .popupContainer .prodListings ul li button:not('.custNextCTA')", function(){
            ...
            if(strProdType == 'regular'){
                ...
                strFeatures  = "<li>A perfect complement to EMUAID<sup data-uw-styling-context='true'>Â®</sup> First Aid Ointment, EMUAID<sup data-uw-styling-context='true'>Â®</sup> Therapeutic Moisture Bar deeply cleanses and detoxifies the skin, delivers intense hydration and restores moisture, exfoliates to promote cellular turnover and stimulates natural skin regeneration.</li><li>Use on face and body - excellent for shaving or shampoo.</li><li>No parabens, phthalates, paraffin, gluten, propylene glycol, mineral oil, synthetic fragrance, PABA, synthetic color, DEA or sulfates.</li>";
            ...
            jQuery('.custMainQuizPopup .popupContainer .smallPopup .custBottomNavigation .btn-skip').attr('cust-data-type',strProdType);
        ...
        jQuery(document).on('click', '.custMainQuizPopup .popupContainer .smallPopup .custQuizForm .formField button.custRevealDiscountCTA', function(){
            ...
            if(strEmail == "" || !regex.test(strEmail)){
                ...
                var strProdTypeAttr = jQuery(this).attr('cust-data-type');
                setProdSizeData(strProdTypeAttr);
                jQuery('.custMainQuizPopup .popupContainer p.custBlueTag').show();
                isDiscountSkip = 0;                
            }
        });


        function setProdSizeData(strProdTypeAttr){
        ...
        //on click of size, set discount coupon 
