            ...
            if(sessionStorage.getItem('customQuizCtaClosed') === null ){
                ...
                var interval = setInterval(function(){
                    ...
                    if(jQuery('.customQuizCta').length == 0 && jQuery('header:not(#header) .tmenu--wrap nav.tmenu_navbar ul.tmenu_nav').length > 0){
                        ...
                        jQuery('<li class="tmenu_item tmenu_item--root tmenu_item_level_0 tmenu_item_submenu_type_flyout customQuizCta"> <a class="tmenu_item_link custTakeQuizCTA"> <span class="icon"> <img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/quiz_icon.svg"> </span> <span class="tmenu_item_text">Take the Quiz</span> </a></li><li class="tmenu_item tmenu_item--root tmenu_item_level_0 tmenu_item_submenu_type_flyout tmenu_item_has_child custCallNav"> <a href="javascript:;" target="_self" title="Call EMUAID®" class="tmenu_item_link"> <span class="tmenu_item_text"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/call_icon.svg"> </span> </a> <ul class="tmenu_submenu tmenu_submenu_type_flyout tmenu_submenu--desktop tmenu_submenu_flyout_position_automatic"> <li> <a href="tel:+18008813900"> <div class="icon"> <img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/call_icon.svg"> </div><div class="text"> Call Toll Free <span>1-800-881-3900</span> </div></a> </li><li> <a href="tel:+18884501718"> <div class="icon"> <img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/text_icon.svg"> </div><div class="text">Text Toll Free<span>1-888-450-1718</span> </div></a> </li><li class="time"> <a href="javascript:;" target="_self"> <div class="icon"> <img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/clock_icon.svg"> </div><div class="text">M-F: 8:30AM-6PM EST<span>Sat-Sun Closed</span> </div></a> </li></ul></li>').appendTo('header:not(#header) .tmenu--wrap nav.tmenu_navbar ul.tmenu_nav');
