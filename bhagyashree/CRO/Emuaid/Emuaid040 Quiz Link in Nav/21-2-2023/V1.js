    ...
    if (typeof jQuery != 'undefined') {
        ...
        function addCustQuizCtaAndPopup() {
            ...
            if (window.location.toString().includes("search")) {
                console.log("show search text >>>> ");
               jQuery('.jsc-search-container.search-container').show();
            }
        }
        ...
        function addCustomHTMLDesktop(){
            if(jQuery('.customQuizCta').length == 0 && jQuery('header:not(#header) .tmenu--wrap nav.tmenu_navbar ul.tmenu_nav').length > 0) {
                    jQuery('<div class="custNavLinksMain"><div class="tmenu_item tmenu_item--root tmenu_item_level_0 tmenu_item_submenu_type_flyout customQuizCta"> <a class="tmenu_item_link custTakeQuizCTA"> <span class="icon"> <img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/quiz_icon.svg"> </span> <span class="tmenu_item_text">Take the Quiz</span> </a></div><div class="tmenu_item tmenu_item--root tmenu_item_level_0 tmenu_item_submenu_type_flyout tmenu_item_has_child custCallNav"> <a href="javascript:;" target="_self" title="Call EMUAID®" class="tmenu_item_link"> <span class="tmenu_item_text"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/call_icon.svg"> </span> </a> <ul class="tmenu_submenu tmenu_submenu_type_flyout tmenu_submenu--desktop tmenu_submenu_flyout_position_automatic"> <li> <a href="tel:+18008813900"> <div class="icon"> <img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/call_icon.svg"> </div><div class="text"> Call Toll Free <span>1-800-881-3900</span> </div></a> </li><li> <a href="tel:+18884501718"> <div class="icon"> <img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/text_icon.svg"> </div><div class="text">Text Toll Free<span>1-888-450-1718</span> </div></a> </li><li class="time"> <a "> <div class="icon"> <img src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/clock_icon.svg"> </div><div class="text">M-F: 8:30AM-6PM EST<span>Sat-Sun Closed</span> </div></a> </li></ul></div></div>').insertAfter('header.jsc-main-nav-menu .tmenu_navbar');
                    ...
                    if(jQuery('.custSearchNav').length == 0 && jQuery('.custCallNav').length > 0) {
                        jQuery('<div class="tmenu_item tmenu_item--root tmenu_item_level_0 tmenu_item_submenu_type_flyout tmenu_item_has_child custSearchNav"> <a href="javascript:;" target="_self" title="Call EMUAID®" class="tmenu_item_link"> <span class="tmenu_item_text"><img class="custSearchIcon" src="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/search-icon.svg"></span></a></div>').insertAfter('.custCallNav');
                    }
        ...
        jQuery("body").on("click", function(event){
            ...
            if(event.target.id !== "searchbox" && event.target.className.indexOf('custSearchIcon') === -1){
                console.log("reset search");
               
               if(jQuery('header.jsc-main-nav-menu .jsc-search-container').css('display') == "block"){
                    jQuery('.search__form')[0].reset();
                    jQuery('header.jsc-main-nav-menu .jsc-search-container').hide();
               }
        ...
        jQuery(document).on('click','.custSearchNav', function (){
            ...
            //jQuery('.jsc-search-container.search-container').toggle();
             //jQuery('header.jsc-main-nav-menu .jsc-search-container').toggle();
                if(jQuery('header.jsc-main-nav-menu .jsc-search-container').css('display') == "block"){
                    jQuery('.search__form')[0].reset();
                    jQuery('header.jsc-main-nav-menu .jsc-search-container').hide();
                }
                else{
                    jQuery('header.jsc-main-nav-menu .jsc-search-container').show();
                }
        });
