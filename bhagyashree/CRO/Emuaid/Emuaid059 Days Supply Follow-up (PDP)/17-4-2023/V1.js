var waitForJquery = setInterval(function() {  
    if (typeof jQuery != 'undefined') {
        ...
        if(jQuery('.product .bm_020_secondProduct p.bm_020_savePercentage').length > 0 && jQuery('.product .bm_020_secondProduct p.bm_020_quantityPrc').length > 0 ){
            ...
            if( jQuery('#custSecondWrap').length == 0 ){
                jQuery('.product .bm_020_secondProduct p.bm_020_quantityPrc, .product .bm_020_secondProduct p.bm_020_savePercentage').wrapAll("<div id='custSecondWrap' class='customSaveTag'></div>");
            }
        }
        ...
        if(jQuery('.product .bm_020_thirdProduct p.bm_020_savePercentage').length > 0 && jQuery('.product .bm_020_thirdProduct p.bm_020_quantityPrc').length > 0 ){
            ...
            if( jQuery('#custThirdWrap').length == 0 ){
                jQuery('.product .bm_020_thirdProduct p.bm_020_quantityPrc, .product .bm_020_thirdProduct p.bm_020_savePercentage').wrapAll("<div id='custThirdWrap' class='customSaveTag'></div>");
            }
