function manageHpReturnUserCustomBannerTop(){
    if(jQuery('#header').length > 0){
        var intHeaderHt = jQuery('#header').outerHeight();
        jQuery('.custHpReturnHeroBanner').attr('style','margin-top:'+ intHeaderHt+'px');
    }
}
var intCount = 0;
...
function addCustHpReturnHeroConditionHtml() {
    if(jQuery('.custHpReturnEmuaidConditionWrapper').length == 0) {
        ...
        if( jQuery(window).width() <= 767 ){
            manageHpReturnUserCustomBannerTop();
        }
...
const sliders = document.querySelectorAll('.custHpReturnProductCategories .custHpReturnProdCondition');
