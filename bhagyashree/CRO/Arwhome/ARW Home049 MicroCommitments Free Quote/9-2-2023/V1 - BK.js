var waitForJquery = setInterval(function() { 
    if (typeof jQuery != 'undefined') {
        ...
        jQuery(document).on('click','.container.custQuteMainSection .custQuoteStartSection#start button.btn.custQuoteBtn', function(){
        	...
        	console.log("strSelectedHomeType >>> " +strSelectedHomeType);
        	...
        	sessionStorage.setItem("custSelectedHomeType", strSelectedHomeType);
        });
        ...
        jQuery(document).on('click','.container.custQuteMainSection .custQuoteStartSection#application button.btn.custQuoteBtn', function(){
        	...
        	let arrActiveAppliances       = [];
        	let strSelectedAppliancesType = jQuery('.container.custQuteMainSection .custQuoteStartSection#application ul li .custIconBox.active')[0].id;
        	
        	console.log("strSelectedAppliancesType >>> " +strSelectedAppliancesType);
        	...
        	jQuery(".container.custQuteMainSection .custQuoteStartSection#application ul li .custIconBox.active").each(function(){
			    arrActiveAppliances.push(jQuery(this)[0].id);
			});
			sessionStorage.setItem("custSelectedAppliancesType",JSON.stringify(arrActiveAppliances));
        ...
        jQuery(document).on('click', '.page-quote .container.custQuteMainSection .custQuteStepsMain .custBackArrow', function () {
        	...
        	if(strStep == 'Application'){
				//JSON.stringify(arrActiveAppliances)
        		/*var arrAppliances = sessionStorage.getItem("custSelectedAppliancesType");
        		console.log(arrAppliances);

        		arrAppliances = jQuery.parseJSON(arrAppliances);
        		console.log(arrAppliances);

        		arrAppliances.forEach(function(item) {
				    jQuery('#'+arrAppliances).addClass('active');
				});*/
