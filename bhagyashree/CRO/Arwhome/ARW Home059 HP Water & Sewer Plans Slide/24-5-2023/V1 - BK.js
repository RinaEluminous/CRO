    		...
    		var intInterval = setInterval( function () {
				...
				if(jQuery('body').length  > 0) {
					if(jQuery('.custBurstPipeRuin').length == 0 ) {
    					jQuery('<div class="custBurstPipeRuin"><div class="close-arrow"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/ARW/close-arrow.svg"></div><h3>Don\'t Let a Burst Pipe Ruin Your Home</h3> <p>Read more about why protecting your water &amp; sewer lines is so important.</p><a href="https://arwhome.com/wsl-plan"> <span>Learn More</span> </a></div>').appendTo('body');
    				}
				}
