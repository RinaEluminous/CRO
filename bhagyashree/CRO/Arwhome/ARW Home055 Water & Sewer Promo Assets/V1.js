    ...
    if (typeof jQuery != 'undefined') {
        ...
        jQuery(document).on('click','.custPopupBlocks .custSubmitBtn', function (){
        	...
        	//setTimeout(function (){
				...
				var strEmail   	 = jQuery('.custPopupBlocks #email').val();
				var intPhone   	 = jQuery('.custPopupBlocks #phone').val();
	    		...
	    		/*iframe.contents().find('input[name="dtc_first_name"]').val(strFirstName);
				...
				iframe.contents().find('input[name="dtc_last_name"]').val(strLastName);
	    		...
	    		iframe.contents().find('input[type="email"]').val(strEmail);
