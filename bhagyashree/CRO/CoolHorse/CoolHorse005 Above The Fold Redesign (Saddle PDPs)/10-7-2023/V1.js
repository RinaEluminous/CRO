    ...
    if (typeof jQuery != 'undefined') {
    	...
    	function addCustomHtmlToPDP(){
			...
			if( jQuery('.custGetYourOffer').length == 0 ){
				jQuery('<div class="custGetYourOffer"><a href="https://shop.coolhorse.com/store/saddle-trade">Want to sell or trade your saddle? <span>Get your offer</span></a></div>').prependTo('main');				
			}
			...
			if( jQuery('.custFreeShippingPdp').length == 0 && strElement !== '') {
				jQuery('<div class="custFreeShippingPdp"><ul><li><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/Coolhorse/np_return.png"></span>14-day Return</li><li><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/Coolhorse/np_delivery.png"></span>Free Shipping</li></ul></div>').prependTo(strElement);
			}
			...
			//wrap each accordion in main div
