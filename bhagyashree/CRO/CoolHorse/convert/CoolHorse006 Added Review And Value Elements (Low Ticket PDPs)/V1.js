var waitForJquery = setInterval(function() { 
    if (typeof jQuery != 'undefined') {
    	...
    	//on updating the product quantity, update the payment text
		...
		//on click of the custom live chat CTA, trigger default chat CTA
		jQuery('.custNeedMoreInformation ol li#custLiveChat').on('click',function() {
