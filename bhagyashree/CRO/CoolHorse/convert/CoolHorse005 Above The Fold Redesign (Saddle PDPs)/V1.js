    ...
    if (typeof jQuery != 'undefined') {
    	...
    	function addCustomHtmlToPDP(){
			...
			if( jQuery('.custNeedMoreInformationPdp').length == 0 && strElement !== ''){
				...
				jQuery('<div class="custNeedMoreInformationPdp"><div><img src="https://growth-hit.s3.us-west-2.amazonaws.com/coolhorse/more-information-avtar.png"></div><div><h3>Need more information?</h3><p>Our friendly Saddle specialists are here to help. Give us a call now or request info.</p><ul><li>Working hours:</li><li><span>M-F: 9 am - 6pm CST</span><span>SAT: 9 am - 4pm CST</span></li></ul></div><ol><li><a href="tel:806-468-9121"><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/Coolhorse/np_phone.jpg"></span>806-468-9121</a></li><li id="custLiveChat"><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/Coolhorse/np_chat.jpg"></span>Live Chat</li></ol></div>').insertAfter(strElement);
			    }
		...
		jQuery('.custNeedMoreInformationPdp ol li#custLiveChat').on('click',function () {
		...
		//on custom 'Make an Offer' CTAs trigger the default Make an offer CTA
		jQuery(document).on('click','.custMakeAnOffer button', function () {
