	    		...
	    		if (jQuery('#js-product-list .category-product').length > 0) {
	    			jQuery('#js-product-list .category-product').each(function(index) {
				        ...
				        if (index == 1 && jQuery('.custGreatProductPlpSearch').length == 0) {
								  ...
								  var reviewsArray = [
									{
										...
										textString : "Love CoolHorse. Always great service and FAST delivery! Everything we have ordered has been of great quality! The prices are wonderful! And the shipments come quick! Appreciate y'all!",
										userNameString: '-Allison A'
									},
									{
										imageUrl: 'https://growth-hit.s3.us-west-2.amazonaws.com/Coolhorse/cool-horse-rosle-e.png',
										textString: "I was not disappointed with the pricing or the experience. The ease of their website, the accuracy of inventory, their shipping results, and I just love the chat because they are real and Johnny On It. I also love the rewards, they are simple, they don't hound you every day with emails. What a great company that understands .... The Cowboy Way! Thanks",
										userNameString: '-Rosie E'
									},
									{
										imageUrl: 'https://growth-hit.s3.us-west-2.amazonaws.com/Coolhorse/cool-horse-jean-c.png',
										text: "I appreciated the informative help I received with the chat options. As a beginner, I didn't understand all the specifics about different kind of ropes. She helped me to find a left-handed 36 ft rope that will be an all-around good ranch rope for many purposes. Thank you Kelly!",
										userNameString: '-Jean C'
									},
									{
										imageUrl: 'https://growth-hit.s3.us-west-2.amazonaws.com/Coolhorse/cool-horse-akauu.png',
										text: "Thanks for taking care of your Hawaii customers with fair shipping options, and also taking care of your left handed ropers!!",
										userNameString: '-akauu'
									},
									{
										imageUrl: 'https://growth-hit.s3.us-west-2.amazonaws.com/Coolhorse/cool-horse-stacey-j.png',
										text: "Great customer service. They have gone out of their way to find what I need even when shopping online you can chat with a real person that is extremely helpful.",
										userNameString: '-Stacey J'
									},
									{
										imageUrl: 'https://growth-hit.s3.us-west-2.amazonaws.com/Coolhorse/cool-horse-melissa-j.png',
										text: "Easy to navigate, and search for what I wanted. Was motivated to buy here (vs other places) b/c I had reward points - thanks!",
										userNameString: '-Melissa J'
									},
								];
								// Get a random index 
								...
								jQuery('<div class="custGreatProductPlpSearch column half medium-one-third large-one-fourth category-product ng-scope" style="background:url('+randomReviewsContent.imageUrl+')"><h5>"'+randomReviewsContent.text+'"<span>'+randomReviewsContent.userNameString+'</span></h5></div>').insertAfter(this);
				        }
				        else{
