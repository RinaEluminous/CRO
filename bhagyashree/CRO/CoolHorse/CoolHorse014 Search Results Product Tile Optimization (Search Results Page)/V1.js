	    		...
	    		if (jQuery('#js-product-list .category-product').length > 0) {
	    			jQuery('#js-product-list .category-product').each(function(index) {
				        ...
				        if (index == 1 && jQuery('.custGreatProductPlpSearch').length == 0) {
								...
								console.log("before randomReviewsIndex >>" + randomReviewsIndex);
								
								console.log("session randomReviewsIndex >>" + sessionStorage.getItem('custIndex'));
								...
								console.log("randomReviewsIndex >>" + randomReviewsIndex) ;
