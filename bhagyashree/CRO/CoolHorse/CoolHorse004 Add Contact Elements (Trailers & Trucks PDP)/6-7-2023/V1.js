    ...
    if (typeof jQuery != 'undefined') {
    	...
    	function addCustomHtmlToPdp(){
			...
			if(jQuery('.custNeedMoreInformationFour').length == 0 ){
				jQuery('<div class="custNeedMoreInformationFour"><div><img src="https://growth-hit.s3.us-west-2.amazonaws.com/Coolhorse/need-more-information.png"></div><div><h3>Got questions?</h3><p>Our friendly Trailer & Coach specialists are here to help. Give us a call now or live chat.</p><ul><li>Working hours:</li><li><span>M-F: 9 am - 6pm</span><span>CSTSAT: 9 - noon CST</span></li></ul></div><ol><li><a href="tel:806-468-9121"><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/Coolhorse/np_chat.jpg"></span>806-468-9121</a></li><li id="custLiveChat"><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/Coolhorse/np_phone.jpg"></span>Live Chat</li></ol></div>').insertAfter('.custMonthlyPlans');
			}
