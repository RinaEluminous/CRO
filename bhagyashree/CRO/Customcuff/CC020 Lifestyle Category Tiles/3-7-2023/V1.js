var waitForJquery = setInterval(function() { 
   ...
   if (typeof jQuery != 'undefined') {
   		...
   		//check if it is collection page
		...
		//add 'Customize' CTA to all porducts
		...
		//build array of all products on collection page and get ajax call for first image
	    ...
	    //fire ajax call and get product lifestyle imaeg from PDP
		...
		//re-position the category roundal block
  		...
  		//show first 6 produdcts on page load and add 'Show  More' CTA to load more products
		function onCollectionPageLoad() {
 		...
 		//on click of the 'Show more' CTA show other 3 products
		...
		//on click of the sort filter again call custom functions
