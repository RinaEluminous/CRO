console.log("CC022: Landing Page Product Tests | V3");
var waitForJquery = setInterval(function() { 
	...
	function updateLandingPageImages(){
		...
		if(jQuery('.swiper-reviews-ingredients-desk #slider-reviews .content:contains(COORDINATES)').length > 0){
			jQuery('.swiper-reviews-ingredients-desk #slider-reviews .content:contains(COORDINATES) img').addClass('custImgV3');
		...
		if( jQuery('.swiper-reviews-ingredients-desk #slider-reviews .content:contains(TEXT)').length > 0 ){
			jQuery('.swiper-reviews-ingredients-desk #slider-reviews .content:contains(TEXT) img').addClass('customTextImgV3');
	...
	jQuery(document).on('click','.custPriceButton' , function() {
		...
		console.log("arrProdAttribute >>> ");
		console.log(arrProdAttribute[strKey]);
