var waitForJquery = setInterval(function() { 
	...
	function updateLandingPageImages(){
		...
		if(jQuery('.swiper.swiper-review #slider-reviews .content:contains(COORDINATES)').length > 0) {
			jQuery('.swiper.swiper-review #slider-reviews .content:contains(COORDINATES) img').addClass('custImg');
			jQuery('.custImg').attr({
		...
		if(jQuery('.swiper.swiper-review #slider-reviews .content:contains(TEXT)').length > 0) {
			jQuery('.swiper.swiper-review #slider-reviews .content:contains(TEXT) img').addClass('customTextImg');
