    ...
    if (typeof jQuery != 'undefined') {
        ...
        function customShopMenuNavigation(){
            ...
            if(jQuery(window).width() <= 1139){
                ...
                if(jQuery('.SidebarMenu .Collapsible:contains(BLOGS)').length > 0){
                    if(jQuery('.SidebarMenu .Collapsible a.Collapsible__Button[href="/blogs/custom-jewelry"] .img_icon').length == 0){
                        jQuery('<div class="img_icon"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/custom-cuff/menu-blogs.png"></div>').prependTo('.SidebarMenu .Collapsible a.Collapsible__Button[href="/blogs/custom-jewelry"]');
                    }
                }
