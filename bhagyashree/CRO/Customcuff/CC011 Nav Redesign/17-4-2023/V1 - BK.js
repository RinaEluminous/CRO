var waitForJquery = setInterval(function() { 
    ...
    if (typeof jQuery != 'undefined') {
        ...
        jQuery(document).on('click','.custNavigation .custShopMenu', function () {
            if(jQuery('.custNavigation .custMenuList.custMenuExpand').length > 0) {
                jQuery('.custNavigation .custMenuList.custMenuExpand')[0].click();
            }
        });
