var waitForJquery = setInterval(function() {  
    ...
    if (typeof jQuery != 'undefined') {
		...
		var strCouponCode    = 'CC009-Test10';
		...
		function setAutoCouponCodeCheckout(){
			if(jQuery('#order-summary .tags-list').length == 0 && jQuery('#order-summary .tags-list .reduction-code__text').text().indexOf('CC009-Test10') === -1){
