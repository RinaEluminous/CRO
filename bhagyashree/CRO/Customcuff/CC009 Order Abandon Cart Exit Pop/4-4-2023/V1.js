var waitForJquery = setInterval(function() {  
    ...
    if (typeof jQuery != 'undefined') {
		...
		function customCCpopup(){
			...
			if( (  jQuery('.custom-checkout').length  > 0 && jQuery('.custom-checkout .sidebar tr.product').length > 0 ) && jQuery('.custCCpopupCartExit').length == 0 && sessionStorage.getItem('custIsCCPopupClose') === null ) {
