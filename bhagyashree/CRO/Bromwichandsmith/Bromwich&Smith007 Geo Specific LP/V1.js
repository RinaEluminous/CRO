var waitForjQuery = setInterval(function() {
  if (typeof jQuery != 'undefined') {
  	console.log("%c Geo Specific LP | 1", "background:red;color: white;padding:10px");

  	updateGeoSpecificLPHtml();
	...
	window.XMLHttpRequest = newXHR;*/
  	...
  	if (performance.navigation.type == 2) {
		...
		var intChkHtmlInterval = setInterval(function (){
			...
			if(jQuery('.customGeoPage').length == 0 && jQuery('body[data-once="form-single-submit detailsAria"] #content-wrapper main article.landing-page .node__content').length > 0){
  				updateGeoSpecificLPHtml();
