var waitForjQuery = setInterval(function() {
	if (typeof jQuery != 'undefined') {
		console.log('Bromwich&Smith013: Blog Ad (Blog Pages) | 1');
		addCustHtmlToBlog();
