var waitForjQuery = setInterval(function() {
  if (typeof jQuery != 'undefined') {
    ...
    console.log("strParentEle >> " + strParentEle);
    jQuery(window).scroll(function() {
      console.log("on scroll >> " + strParentEle);
        startCounters();
    });
    ...
    function startCounters(){
      ...
      if(jQuery(strParentEle + '.custYearCounter').length > 0){
        ...
        console.log("Len >> " + jQuery(strParentEle +'.custYearCounter').length);

        if (elementInView(jQuery(strParentEle + '.custYearCounter'))) {
          console.log("YearCounter in viewport");
          if(yearFlag == 0) {
              yearFlag = 1;
