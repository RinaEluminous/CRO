var waitForjQuery = setInterval(function() {
	if (typeof jQuery != 'undefined') {
	  ...
	  console.log('Bromwich&Smith015: PPC Hero Contact Form | Fired... | V1');
	...
	var oldXHR = window.XMLHttpRequest;
			  ...
			  if(realXHR.readyState == 4 && realXHR.status == 200){
				  setTimeout(function () {           
					   var strAjaxResponseURL  = realXHR.responseURL;
					  	//console.log("strAjaxResponseURL >> ");
					  	//console.log(strAjaxResponseURL);
	  ...
	  function addCustomHtmlToPage(){
		...
		function custLeftPanelHtml(){
			if(jQuery('.custLeftPanelSection').length == 0){
				if(jQuery('body[data-once="form-single-submit detailsAria"] #content-wrapper main article.landing-page .node__content  div[id^=tile-] .jumbotron .container:has(.group-left)').length > 0){
					jQuery('body[data-once="form-single-submit detailsAria"] #content-wrapper main article.landing-page .node__content  div[id^=tile-] .jumbotron .container:has(.group-left)').addClass('custLeftPanel');
				}
			console.log("custLeftPanel Len >>" + jQuery('.custLeftPanel .group-left').length);
			  jQuery('<div class="custLeftPanelSection"><div class="custHeroSection"> <div class="container"> <div class="custHeroContent"> <h5>Emergency Government Debt Relief</h5> <h2>Reduce Your Debt Up To 85%</h2> <ul> <li>Roll your debt into one easy payment with 0% interest.</li><li>No more annoying collection calls from harrassing creditors</li><li>Conquer debt now and learn how to rebuild your credit</li></ul> <div class="heroBthSection"> <div class="btnWraper"> <div class="reviews"><a href="#review-widget-slider"> <div class="googleIcon"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/bromwichandsmith/google-icon.svg"> </div><div class="reviewContent"> <div class="reviewsStarWraper"> <div class="starsWraper"> <div class="starsCount">4.9</div><div class="starsListing"><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/bromwichandsmith/Star-icon.svg"></span><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/bromwichandsmith/Star-icon.svg"></span><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/bromwichandsmith/Star-icon.svg"></span><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/bromwichandsmith/Star-icon.svg"></span><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/bromwichandsmith/Star-icon.svg"></span> </div></div></div><div class="reviewsNumber">938 Google Reviews</div></div></a></div></div></div></div><div class="custHeroImage"><img class="img-fluid" src="https://growth-hit.s3.us-west-2.amazonaws.com/bromwichandsmith/geo-hero-img.png"></div></div></div>').prependTo('.custLeftPanel .group-left');
		...
		function modifyContactFormHTML(){
			if(jQuery('.webform-submission-form').length > 0){
			  ...
			  jQuery('.webform-submission-form .js-form-item input[name="postal_code"]').attr('placeholder','Postal Code');
				...
				if(jQuery('.webform-submission-form .js-form-submit.form-submit').length > 0){
					...
					console.log("show form 1111 >>>> ");
					jQuery('body[data-once="form-single-submit detailsAria"] #content-wrapper main article.landing-page .node__content div[id^=tile-] .webform-ajax-form-wrapper').parents('div[id^="tile-"]').show();
				}

				console.log("show form >>>> ");
				console.log("form Len >>>  ");
				console.log(jQuery('body[data-once="form-single-submit detailsAria"] #content-wrapper main article.landing-page .node__content div[id^=tile-] .webform-ajax-form-wrapper').parents('div[id^="tile-"]').length);
				jQuery('body[data-once="form-single-submit detailsAria"] #content-wrapper main article.landing-page .node__content div[id^=tile-] .webform-ajax-form-wrapper').parents('div[id^="tile-"]').show();
		  	}
			...
			console.log("check display >>> " + jQuery('body[data-once="form-single-submit detailsAria"] #content-wrapper main article.landing-page .node__content div[id^=tile-] .webform-ajax-form-wrapper').parents('div[id^="tile-"]').css('display'));

			if(jQuery('body[data-once="form-single-submit detailsAria"] #content-wrapper main article.landing-page .node__content div[id^=tile-] .webform-ajax-form-wrapper').parents('div[id^="tile-"]').css('display') !== 'block' ){
					jQuery('body[data-once="form-single-submit detailsAria"] #content-wrapper main article.landing-page .node__content div[id^=tile-] .webform-ajax-form-wrapper').parents('div[id^="tile-"]').show();
			}
