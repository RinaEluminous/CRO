var waitForjQuery = setInterval(function() {
	if (typeof jQuery != 'undefined') {
	  ...
	  console.log('Bromwich&Smith015: PPC Hero Contact Form | Fired...');
	  ...
	  function updateGeoSpecificLPHtml(){
		...
		function addHtmlToContactPage(){
			if(jQuery('.custLeftColumn').length == 0){
			  jQuery('<div class="custLeftColumn"><div class="custHeroSection"> <div class="container"> <div class="custHeroContent"> <h5>Emergency Government Debt Relief</h5> <h2>Reduce Your Debt Up To 85%</h2> <ul> <li>Roll your debt into one easy payment with 0% interest.</li><li>No more annoying collection calls from harrassing creditors</li><li>Conquer debt now and learn how to rebuild your credit</li></ul> <div class="heroBthSection"> <div class="btnWraper"> <div class="reviews"><a href="#review-widget-slider"> <div class="googleIcon"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/bromwichandsmith/google-icon.svg"> </div><div class="reviewContent"> <div class="reviewsStarWraper"> <div class="starsWraper"> <div class="starsCount">4.9</div><div class="starsListing"><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/bromwichandsmith/Star-icon.svg"></span><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/bromwichandsmith/Star-icon.svg"></span><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/bromwichandsmith/Star-icon.svg"></span><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/bromwichandsmith/Star-icon.svg"></span><span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/bromwichandsmith/Star-icon.svg"></span> </div></div></div><div class="reviewsNumber">938 Google Reviews</div></div></a></div></div></div></div><div class="custHeroImage"><img class="img-fluid" src="https://growth-hit.s3.us-west-2.amazonaws.com/bromwichandsmith/geo-hero-img.png"></div></div></div>').prependTo('body[data-once="form-single-submit detailsAria"] #content-wrapper main article.landing-page .node__content #tile-5744 .jumbotron .container .group-left');
			}
