...
var waitForJquery = setInterval(function() {
	if (typeof jQuery != 'undefined') {
        ...
        function addMaxRegularOnHp(){
            ...
            '                <h3>EMUAIDMAX® First Aid Ointment 2oz</h3>'+
            ...
            '                    <img src="https://cdn.shopify.com/s/files/1/0549/3181/6637/products/emuaidmax_0.5oz_front_E_ca4e1ca6-35ac-4a5c-b083-6df625a4eea0.jpg" alt="EMUAIDMAX® First Aid Ointment 2oz">'+
            '                </div>'+
            '                <a href="https://www.emuaid.com/products/emuaidmax-3" class="buyBtn">Buy Now</a>'+
            '            </div>'+
            '            <div class="custItemBox">'+
            '                <h3>EMUAIDMAX®️ Concentrate Serum</h3>'+
            ...
            '                </ul>'+
            '                <div class="productImage">'+
            '                    <img src="https://cdn.shopify.com/s/files/1/0549/3181/6637/products/01-emuaidMAX-Bottle-Front_2000x.jpg" alt="EMUAIDMAX®️ Concentrate Serum">'+
            '                </div>'+
            '                <a href="https://www.emuaid.com/products/emuaidmax-concentrate-serum" class="buyBtn">Buy Now</a>'+
            '            </div>'+
            '            <div class="custItemBox">'+
            '                <h3>EMUAIDMAX® On-The-Go Ointment 2-Pack (20ml)</h3>'+
            ...
            '                </ul>'+
            '                <div class="productImage">'+
            '                    <img src="https://cdn.shopify.com/s/files/1/0549/3181/6637/files/image_4.svg?v=1702362613" alt="EMUAIDMAX® On-The-Go Ointment 2-Pack (20ml)">'+
            '                </div>'+
            ...
            '                <div class="badge">MOST POPULAR</div>'+
            '                <h3>EMUAID® First Aid Ointment 2oz</h3>'+
            ...
            '                </ul>'+
            '                <div class="productImage">'+
            '                    <img src="https://cdn.shopify.com/s/files/1/0549/3181/6637/products/emuaid_0.5oz_front_E_96de6a22-25ea-4a27-8d57-112ba3ed34cb_2000x.jpg?v=1620715277" alt="EMUAID® First Aid Ointment 2oz">'+
            '                </div>'+
            '                <a href="https://www.emuaid.com/products/emuaid-first-aid-ointment-0-5oz" class="buyBtn">Buy Now</a>'+
            '            </div>'+
            '            <div class="custItemBox">'+
            '                <h3>EMUAID® Therapeutic Moisture Bar</h3>'+
            ...
            '                </ul>'+
            '                <div class="productImage">'+
            '                    <img src="https://cdn.shopify.com/s/files/1/0549/3181/6637/files/Overnight-Acne-Treatment.png?v=1662096653" alt="EMUAID® Therapeutic Moisture Bar">'+
            '                </div>'+
            ...
            '        <div class="custProductItemLists">'+
            '            <div class="custItemBox">'+
            '                <h3>EMUAID® Pain Relieving Cream</h3>'+
            ...
            '                </ul>'+
            '                <div class="productImage">'+
            '                    <img src="https://cdn.shopify.com/s/files/1/0549/3181/6637/files/Pain-Relieving-Cream.png?v=1662096655" alt="EMUAID® Pain Relieving Cream">'+
            '                </div>'+
            ...
            '        <div class="custProductItemLists">'+
            '            <div class="custItemBox">'+
            '                <h3>EMUAID® Overnight Acne Treatment</h3>'+
            ...
            '                </ul>'+
            '                <div class="productImage">'+
            '                    <img src="https://cdn.shopify.com/s/files/1/0549/3181/6637/files/overnight-acne-treatment.webp?v=1662096652" alt="EMUAID® Overnight Acne Treatment">'+
            '                </div>'+
