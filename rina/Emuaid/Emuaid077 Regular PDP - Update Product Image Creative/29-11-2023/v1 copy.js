var waitForJquery = setInterval(function() {
    if (typeof jQuery != 'undefined' && jQuery('.flickity-slider').length > 0) {
        ...
        if (strURL.indexOf('emuaid-first-aid-ointment-0-5oz') > 0) {
            ...
            strMainProductImgDesk = "https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/EMUAID_reg_05oz.png";
            strThumbProductImg = "https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/EMUAID_reg_05oz_thumb.png";
  
        } else if (strURL.indexOf('emuaid-2') > 0) {
  
            strMainProductImgDesk = " https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/EMUAID_reg_2oz.png";
            strThumbProductImg = "https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/EMUAID_reg_2oz_thumb.png";
  
        } else if (strURL.indexOf('emuaid-first-aid-ointment-16oz') > 0) {
  
            strMainProductImgDesk = "https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/EMUAID_reg_16oz.png";
            strThumbProductImg = "https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/EMUAID_reg_16oz_thumb.png";
        ...
        function updatePdpProductImgCreative() {
            ...
            if (jQuery('body[class*="product-"] .product .product__images .gallery-wrap').length > 0 && jQuery('.custProductGallery').length == 0) {
                var custSliderHtml = '<div class="custProductGallery">' +
                    ...
                    '            </div>' +
                    '            <div class="swiper-slide">' +
                    '                <a data-fancybox="gallery" data-zoom="false" href="https://growth-hit.s3.us-west-2.amazonaws.com/emuaid/EMUAID_reg_physician.png">' +
                    ...
                    var swiper = new Swiper(".custProductSliderThumb", {
                        ...
                        on: {
                          ...
                          console.log('Slide changed!');
                            if(this.realIndex == 5){
                              jQuery('.product-gallery__video iframe#youtube-9144').attr('src', 'https://www.youtube.com/embed/yPaCr_sf2wc?autoplay=1&controls=0&disablekb=1&playsinline=0&cc_load_policy=0&cc_lang_pref=auto&widget_referrer=https%3A%2F%2Fwww.emuaid.com%2Fproducts%2Femuaid-2&noCookie=false&rel=0&showinfo=0&iv_load_policy=3&modestbranding=1&enablejsapi=1&origin=https%3A%2F%2Fwww.emuaid.com&widgetid=1');
                            }else{
                              jQuery('.product-gallery__video iframe#youtube-9144').attr('src', 
                              
                              
                              
                              'https://www.youtube.com/embed/yPaCr_sf2wc?autoplay=0&controls=0&disablekb=1&playsinline=0&cc_load_policy=0&cc_lang_pref=auto&widget_referrer=https%3A%2F%2Fwww.emuaid.com%2Fproducts%2Femuaid-2&noCookie=false&rel=0&showinfo=0&iv_load_policy=3&modestbranding=1&enablejsapi=1&origin=https%3A%2F%2Fwww.emuaid.com&widgetid=1');
                            }
                          }
                        }
                    });
