    ...
    if (typeof jQuery != "undefined") {
        ...
        function addBeyondCompareSection() {
            var beyondCompareSectionHtml = '<div class="custBeyondCompSection">' +
                ...
                '                            <th class="wearthis-borders wearthis-middle wearthis-middle-bordertop"> <img decoding="async" loading="lazy" class="wearthis-topImg" src="https://d27c6j8064skg9.cloudfront.net/growthHit/customcuff/CC033/div.lp-pom-image-container%20(1).svg" alt=""></th>' +
                ...
                '                        <img decoding="async" loading="lazy" src="https://d27c6j8064skg9.cloudfront.net/growthHit/customcuff/CC033/icons.svg" alt="">' +
        ...
        jQuery(document).on('click', '.custBeyondCompSection .wearthis-btn', function () {
            var tabAccordTop = parseInt(jQuery('#Product__AddToCart').offset().top - 150);
