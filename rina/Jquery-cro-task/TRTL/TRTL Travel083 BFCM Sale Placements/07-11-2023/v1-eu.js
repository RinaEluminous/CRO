var waitForJquery = setInterval(function() {
    ...
    if (typeof jQuery != "undefined") {
        ...
        var strShopNowUrl = "https://eu.trtltravel.com/collections/shop-all";
  
        if (strURL.indexOf("collections/shop-all") > 0) {
        ...
        function addBlackFridayTopBannerOnPDP() {
            if (strURL.indexOf("/products/vip-family-bundle-free-gift") > 0 || strURL.indexOf("/products/double-comfort-bundle-free-gift") > 0 || strURL.indexOf("/products/mini-family-bundle-free-gift") > 0
               ...
               } else if ( strURL.indexOf("/products/traveling-duo-bundle") > 0 || strURL.indexOf("/products/traveling-trio-bundle") > 0 
            ) {
                var strDiscountCopy = "<span>Get UP TO <span>40% OFF</span> + <span>Free gifts</span></span>";
            } else {
                var strDiscountCopy = "<span>Get UP TO <span>40% OFF</span> + <span>Free gifts</span></span>";
