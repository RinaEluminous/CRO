var waitForJquery = setInterval(function() {
    ...
    if (typeof jQuery != "undefined") {
        ...
        console.log('%c TRTL TRavel 083', 'background: green; color: #fff; padding: 10px');
  
        var strURL = window.location.href;
        var strStartTime = "2023/11/09 09:30:00";
        var strEndTime = "2023/11/26 09:30:00";
        var strShopNowUrl = "https://mena.trtltravel.com/collections/all-products";
        ...
        if (strURL.indexOf("/products/") > 0) {
          console.log('%c CALL PDP FUNCTION', 'background: green; color: #fff; padding: 10px');
            addBlackFridayTopBannerOnPDP();
        }
  
        function addBlackFridayTopBannerOnPDP() {
          console.log('%c IN THE PDP FUNCTION', 'background: green; color: #fff; padding: 10px');
          
          var strDiscountCopy = "GET 10% OFF";
