    ...
    if (typeof jQuery != "undefined") {
        ...
        function homePageSocialProofBenefitV2(){
            ...
            var intSocialProofInterval = setInterval(function() {
                ...
                if (document.querySelector('main#MainContent [id*="shopify-section-template--"] [id*="Banner-template--"]') && !document.querySelector(".custV2BannerMainContainer")) {

                    var targetElement = document.querySelector('main#MainContent [id*="shopify-section-template--"].shopify-section.section:first-child');
                    targetElement.insertAdjacentHTML('beforeend', custV2HtmlOfHomePage);

                    var bannerElements = document.querySelectorAll('main#MainContent [id*="shopify-section-template--"] h2:contains(Fits all your basics)');
                     
                    for (var i = 0; i < bannerElements.length; i++) {
                        bannerElements[i].parentElement.parentElement.classList.add('custV2FitAllSection');
                    }
