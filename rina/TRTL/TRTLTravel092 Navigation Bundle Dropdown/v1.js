console.log('TRTLTravel092: Navigation Bundle Dropdown');
...
console.log('DOMContentLoaded >>>>>>>>>>>>>>>>>>');
    ...
    function addNavigationBundleDropdowns(){
         ...
         if(pillowTabCount > 0 && bundlesTabCount == 0) {
            ...
            console.log('checking bundle dropdowns');
            ...
            '                                            <div class="d-flex flex-nowrap flashtags-container overflow-hidden"><span data-tag-priority="true" class="flashtag rounded-2 flashtag-discount fade-in">20% OFF</span></div>'+
            '                                        </div>'+
            ...
            const navbarLinks = document.querySelectorAll('.section-header nav.navbar ul.navbar-nav li a');
                ...
                navbarLinks.forEach(listItem => {
                    ...
                    if (listItem.textContent.trim() === 'Pillows') {
                        console.log('Found Pillows link');
                        const parentListItem = listItem.parentElement;

                        //insertHTML(parentListItem, 'afterend', strBundleHtml);
                         ...
                         if (flashtags.length > 0) {
                             console.log('BEST SELLER tag found');
            ...
            const doubleComfortBundleLink = document.querySelector('a[aria-label="DOUBLE COMFORT BUNDLE"]');

            const parentSleepMaskCol6 = document.querySelector('a[aria-label="SLEEP MASK"]').closest('.col-6');

            const doubleComfortBundleParentHTML = doubleComfortBundleLink.closest('.col-6').innerHTML;

            parentSleepMaskCol6.innerHTML = doubleComfortBundleParentHTML;
        ...
        mobileNavbarLinksElement.forEach(listItem => {
            ...
            console.log('textContent >>>',listItem.textContent);
            ...
            if (listItem.textContent.trim() === 'Pillows') {
              ...
              const mobileDoubleComfortBundleParentHTML ='<div class="col-12 mt-2">'+
              '    <div class="tile-product-menu text-center overflow-hidden">'+
              '        <div class="row g-0">'+
              '            <div class="position-relative overflow-hidden col-12 mb-3 height-medium custMainProductNav">'+
              '                <div id="image-wrapper-43116221235393-b1b11-198916" class="image-cover overflow-hidden">'+
              ...
              '</div>';
                ...
                if (listItem.textContent.trim() === 'Accessories') {
                console.log('Found Accessories link');
                const collapseElement = listItem.nextElementSibling;
        
                if (collapseElement) {
                    console.log('test');
                    const accessoriesContainer = collapseElement.querySelector('.row .col-6:nth-last-child(3)');
                    if (accessoriesContainer) {
         
                      console.log('DONE')
                      accessoriesContainer.insertAdjacentHTML('beforeend', mobileDoubleComfortBundleParentHTML);
