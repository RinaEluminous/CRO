window.onload = function () {
    ...
    function addCustGetExtramsgFollowup(){
        ...
        '    <p>You are <strong>$20</strong> away from being upgraded to free expedited shipping.</p>'+
    ...
    if (shippingUnlockAlert !== null) {
        ...
        if (col12Elements.length > 0) {
            var custCartFeaturesDiv = document.createElement('div');
            custCartFeaturesDiv.className = 'custCartFeatures';
            col12Elements.forEach(function (element) {
                custCartFeaturesDiv.appendChild(element);
            });
            shippingUnlockAlert.parentNode.insertBefore(custCartFeaturesDiv, shippingUnlockAlert.nextSibling);
        }
    }
