var waitForJquery = setInterval(function() {
   ...
   function generateShipingWrapperSection() {
    ...
    if (intRemHr !== '' && intRemHr !== undefined && intRemMin !== '' && intRemMin !== undefined && strDeliveryDay !== '' && strDeliveryDay !== undefined  && intRandomPurchaseCount !== '' && intRandomPurchaseCount !== undefined) {
        ...
        // var deliveryOutput = strDeliveryDay + ', ' + strDeliveryMonth + ' ' + strCurrentTimeNum + 'th';
        // console.log('deliveryOutput >>>>>>>>>>>>>>>>>>',deliveryOutput);
