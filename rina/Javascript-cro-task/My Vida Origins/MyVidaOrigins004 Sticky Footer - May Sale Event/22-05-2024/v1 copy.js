...
// Get the "Shop Now" button and the "mostPopular_product" section
const shopNowButton = document.querySelector('.custShopNow a');
const mostPopularSection = document.querySelector('.mostPopular_product');

// Scroll to the "mostPopular_product" section when the "Shop Now" button is clicked
