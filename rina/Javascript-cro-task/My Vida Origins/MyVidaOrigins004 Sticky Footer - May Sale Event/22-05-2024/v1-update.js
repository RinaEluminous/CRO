...
function headerBannerOnPDP(){
  ...
  if (validPDPUrls.includes(currentPath)) {
    var changeText = 'Memorial Day Sale!';
  }else if(validPDPUrlsOfParaLymp.includes(currentPath)){
    var changeText = 'Save up to 50% on this product';
  }
...
var pdpBannerHtml ='<div class="custmaySaleEventTopBanner">'+
  '    <div class="custBannerTopHeading">'+
  '            LIMITED TIME ONLY</a>'+changeText+
  '    </div>'+
  '</div>';
