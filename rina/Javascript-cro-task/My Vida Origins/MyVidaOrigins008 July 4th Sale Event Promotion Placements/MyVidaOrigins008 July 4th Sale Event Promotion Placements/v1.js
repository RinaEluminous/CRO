...
function addHeaderBannerSEPro() {
    ...
    var interval = setInterval(() => {
        ...
        if (barElement && headerBannerText != '') {
            ...
            barElement.innerHTML = '<span class="custDaySaleheadingSEPro">' + headerBannerText + '<span class="custTimerSEPro">' + days + ":" + hours + ':' + minutes + ':' + seconds + '</span>';
        }
