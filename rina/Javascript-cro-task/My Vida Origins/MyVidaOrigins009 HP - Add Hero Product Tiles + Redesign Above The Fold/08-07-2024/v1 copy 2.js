...
function redesignAboveFoldOnHPMob(){
    ...
    if(popularProdParaMobElement && bestSellerProductMobElement){
        popularProdParaMobElement.insertAdjacentElement('afterend',bestSellerProductMobElement);
    }
    ...
    if(popularProdParaMobElement && shopLinkMobElement){
        shopLinkMobElement.insertAdjacentElement('beforeend',popularProdParaMobElement);
    }
    ...
    if(partnersLogoMobElement && ratingMetaMobElement){
        ratingMetaMobElement.insertAdjacentElement('beforebegin',partnersLogoMobElement);
    }
