...
function redesignAboveFoldOnHP() {
    ...
    customerContentElement.outerHTML = '<div class="custCustomerContent">' +
       ...
       //Say Goodbye to Joint Pain! section. add shop all link to collection page
       var shopNowGoodByeAnchorElement = document.querySelector('.myvida_joint_pain a');
       if (shopNowGoodByeAnchorElement && shopNowGoodByeAnchorElement.textContent.includes('Shop now')) {
           shopNowGoodByeAnchorElement.href = '/collections';
       }
