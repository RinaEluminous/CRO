...
(function() {
    function loadLightGalleryScript() {
        const script = document.createElement('script');
        script.src = 'https://cdnjs.cloudflare.com/ajax/libs/lightgallery/1.6.4/js/lightgallery-all.min.js';
        script.async = true;

        script.onload = function () {
            console.log('lightgallery script loaded');
            initializeLightGallery(); // Call initialization function after script is loaded
        };

        script.onerror = function () {
            console.error('Error loading lightgallery script.');
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', loadLightGalleryScript);
    } else {
        loadLightGalleryScript();
    }
...
function loadLightGalleryScript() {
    ...
    script.onload = function () {
        console.log('lightgallery script loaded');
        // Additional code to initialize lightgallery or handle post-loading tasks
    };
