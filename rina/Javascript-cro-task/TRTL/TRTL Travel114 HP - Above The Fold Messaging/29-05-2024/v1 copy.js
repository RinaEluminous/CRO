window.onload = function (){
   console.log('TRTL Travel114 HP - Above The Fold Messaging');
...
function addCustomHTMLForHomePage(){
    ...
    '                    <div class="custHeroReview"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/stars.svg" alt="Stars"> 5000+ 5-STAR REVIEWS</div>'+
    '                    <h2 class="custHeroTitle">YOUR BEST SLEEP WHILE TRAVELING</h2>'+
    '                    <h4 class="custHeroSubTitle">Scientifically proven to help you drift off anywhere, anytime. Effective for all kinds of travel.</h4><a href="https://trtltravel.com/products/trtl-travel-pillow" class="custBtn custYellowBtn">SHOP NOW</a>'+
    '                </div>'+
    '            </div>'+
    '        </div>'+
    '    </section>'+
    '    <section class="custProductsWrapper">'+
    '<div class="custSocialProof">'+
    ...
    '                <div class="custProductsWrap swiper-wrapper"><a href="https://trtltravel.com/products/trtl-travel-pillow" class="custProductsCard swiper-slide">'+
    ...
    '                    <div class="custMarqueeWrap"><span>"Its design is unique to anything else"</span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/the-stratergist.png" alt="the stratergist"></div>'+
    '                    <div class="custMarqueeWrap"><span>"I\'ve truly never slept better on a plane"</span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/buzzfeed.png" alt="buzzfeed"></div>'+
    '                    <div class="custMarqueeWrap"><span>"Its design is unique to anything else"</span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/the-stratergist.png" alt="the stratergist"></div>'+
    '                    <div class="custMarqueeWrap"><span>"I\'ve truly never slept better on a plane"</span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/buzzfeed.png" alt="buzzfeed"></div>'+
    '                    <div class="custMarqueeWrap"><span>"Its design is unique to anything else"</span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/the-stratergist.png" alt="the stratergist"></div>'+
    '                    <div class="custMarqueeWrap"><span>"I\'ve truly never slept better on a plane"</span><img src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/buzzfeed.png" alt="buzzfeed"></div>'+
