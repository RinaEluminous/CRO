...
function updateBundleNavImg() {
    ...
    mobileNavbarLinksElement.forEach(function (listItem) {
        ...
        if (paragraph && paragraph.textContent.includes('Includes Free Gift')) {
            ...
            //             node.textContent = node.textContent.replace('DOUBLE COMFORT BUNDLE', 'CHRIS BURKARD X TRTL PILLOW');
...
function addStickyFooterLaunch() {
    ...
    var strLaunchUrl = "https://trtltravel.com/products/chris-burkard-trtl-travel-pillow-cool";
