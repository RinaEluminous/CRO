...
function addKacieRoseCollabPreLaunchStickyFooter(){
      var strPreLaunchUrl = "products/kacie-rose-x-trtl-travel-pillow-cool";
      ...
      if (document.querySelectorAll('.custKacieRoseCollabPreLaunchSticklyFooter').length == 0) {
          preLaunchSticklyFooterHTML = '<div class="custKacieRoseCollabPreLaunchSticklyFooter">'+
                  ...
                  '            <div class="imgWrapper"><a href="' + strPreLaunchUrl + '"><img class="imgDesktop" src="https://trtltravel.com/cdn/shop/files/kacie_rose_footer.png" alt="kacie rose"></a></div>'+
                  ...
                  '            <p><a href="' + strPreLaunchUrl + '" class="stretched-link btn btn-light">GET NOTIFIED'+
                  '                    </a>'+
                  '            </p>'+
                  '        </div>'+
                  '    </div>'+
