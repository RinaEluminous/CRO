...
window.addEventListener('load', function () {
    console.log("'%c All resources are loaded.", 'background: red; color: #fff; padding: 10px;');
...
function updateBundleNavImgNew() {
    ...
    deskKacieRosePillowMenu.forEach(function (element) {
        ...
        if (textElement && (textElement.textContent.includes('Includes Free Gift') || textElement.textContent.includes('Includes free gift'))) {
    ...
    mobileNavbarLinksElement.forEach(function (listItem) {
        ...
        if (paragraph && (paragraph.textContent.includes('Includes Free Gift') || paragraph.textContent.includes('Includes free gift'))) {
            ...
            if (headingElement && (headingElement.textContent.includes('Includes Free Gift') || paragraph.textContent.includes('Includes free gift'))) {
