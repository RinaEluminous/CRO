...
function addHideClass() {
    ...
    jQuery('[id*="__main"] .product-container [id*="product-media-template"]').parents('[id*="__main"].shopify-section').addClass('custBrandFocusProductHero');

    //hide unwanted sections
    
    if( jQuery('h2:contains(Over 30,000 Reviews on Amazon Globally)').parents('[id*="shopify-section-template"]').length > 0){
        jQuery('h2:contains(Over 30,000 Reviews on Amazon Globally)').parents('[id*="shopify-section-template"]').addClass('hideContent');    
    }
    
    
    if(jQuery('h2:contains(What Our Community Thinks)').parents('[id*="shopify-section-template"]').length > 0){
        jQuery('h2:contains(What Our Community Thinks)').parents('[id*="shopify-section-template"]').addClass('hideContent');
    }
 
   
    if(jQuery('h2:contains(Testimonials)').parents('[id*="shopify-section-template"]').length > 0){
        jQuery('h2:contains(Testimonials)').parents('[id*="shopify-section-template"]').addClass('hideContent');
    }
 
    if(jQuery('a:contains(Write a Review)').parents('[id*="shopify-section-template"]').length){
        jQuery('a:contains(Write a Review)').parents('[id*="shopify-section-template"]').addClass('hideContent');
    }
...
function trtlePillowPdpNewDesign() {
    ...
    var strAfterHeroHtml = '<div class="custPDPbrandBodymain">' +
     ...
     if (jQuery('.custBrandFocusProductHero').length > 0 && jQuery('.custPDPbrandBodymain').length == 0 && jQuery('.custBrandReviewMain').length == 0 && jQuery('.custReviewMainBoxWraper').length == 0 && jQuery('.custMayAlsoLikeWraper').length == 0) {
        jQuery(strAfterHeroHtml).insertAfter('.custBrandFocusProductHero');
    ...
    //change position 
    if (jQuery('.custBrandFocusProductHero .product-container .product-description .content > span').length > 0) {
        jQuery('.custBrandFocusProductHero .product-container .product-description .content > span').insertAfter('body.template-product #MainContent [id*="__main"] .product-container form[id*="__main"].product-form h1');
    }
