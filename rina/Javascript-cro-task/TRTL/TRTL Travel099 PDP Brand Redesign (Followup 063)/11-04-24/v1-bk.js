...
function trtlePillowPDPRedesign(){
    ...
    if(window.screen.width <= 767){
        //change position of Title for mobile devices
        // const productMediaElement = document.querySelector('#product-media-template--21874614599873__main');
        // if(productMediaElement && !document.querySelector('.custProTitle')){
        //     productMediaElement.insertAdjacentElement('beforebegin', '<h1 class="h3 text-uppercase m-0 ls-1-5 custProTitle">TRTL TRAVEL PILLOW fdsfds</h1>');
        // }
