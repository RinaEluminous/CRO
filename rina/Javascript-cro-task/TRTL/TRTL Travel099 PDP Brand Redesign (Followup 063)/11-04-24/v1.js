...
function generateShipingWrapperPDPSection(){
    ...
    if (strDay !== '' && strDeliveryMonthShort !== '' && intRandomPurchaseCount !== '' && strDeliveryDay !== undefined && strDeliveryDay !== '') {
        ...
        <div class="custShippingFocusWraper">
          <div class="inside">
...
function trtlePillowPDPRedesign(){
    ...
    '    </section>'+
    '</div>'+
    '<div class="custBrandReviewFocus">'+
    '    <div class="container">'+
    ...
    const partnersMainElement = document.querySelector('.custPartnersMain');
    const ultimateFocusTravelElement = document.querySelector('.custUltimateFocusTravel');
    ...
    if(window.screen.width <= 767){
        ...
        const shippingFocusWraperElement = document.querySelector('.custShippingFocusWraper');
...
const imgElement = document.querySelector('.custBrandReviewFocus .custReviewBox .imgCol img');
const imgHeight = imgElement ? parseFloat(window.getComputedStyle(imgElement).height) : 0;
const sliderControlsElement = document.querySelector('.custBrandReviewFocus .custSliderControls');
...
function stickyFooter(){
    ...
    const stickyFooterHtml = '<div class="custStickyProductBuy bg-beige">'+
    ...
    // if (document.body.classList.contains('template-product #product-sticky-bu') && !document.querySelector('.custStickyProductBuy')) {
...
function addMainSlider(){
    var mailSliderHtml ='<div class="custMainProductSliderWrapper">'+
    ...
    if (mainContentElement && !document.querySelector('.custMainProductSliderWrapper')) {
...
function allclicks(){
  ...
  const tabs = document.querySelectorAll('.custPDPfeatureFocusTabs .tab');
...
var swatchesButtons = document.querySelectorAll('.custStickyProductBuy .colorSwatch');
swatchesButtons.forEach(function(btn) {
    btn.addEventListener('click', function() {
       
        var allSwatches = document.querySelectorAll('.custStickyProductBuy .colorSwatch');
