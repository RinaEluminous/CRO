...
(function () {
    ...
    console.log('TRTL Travel094 - Cart Upsell Followup >>>');
        ...
        function addCustomUpSellProduct() {
            var custUpSellProductHtml = '<div class="custCartFollowupWraper">'+
                                        ...
                                        '                    <div class="price">'+
                                        '                        <div class="mainPrice">$53.99</div>'+
                                        '                        <div class="cancelPrice">$59.99</div>'+
                                        '                    </div>'+
                                        '                </div>'+
                                        ...
                                        '                    <div class="price">'+
                                        '                        <div class="mainPrice">$35.99</div>'+
                                        '                        <div class="cancelPrice">$39.99</div>'+
                                        '                    </div>'+
                                        '                </div>'+
                                        '                <div class="addBtn">Add</div>'+
                                        '                <div class="custProducts-colour-variant-swatches" id="custProducts-variant-swatches">'+
                                        ...
                                        '                <img src="https://trtltravel.com/cdn/shop/products/DSC09507_96943520-c5f9-4141-bc83-516aa7c62b7b_620x.jpg" alt="">'+
                                        '            </div>'+
                                        '            <div class="coverConent">'+
                                        '                <p><span>+ FREE PASSPORT COVER <em>($34.99 VALUE)</em></span> INCLUDED WHEN YOU ADD A DEAL TO CART</p>'+
                                        '            </div>'+
                                        '        </div>'+
                                        '    </div>'+
                                        '</div>';
        ...
        function modifyExistingCartContent() {
           ...
           wrapperDiv.classList.add('custMiniCartFeatures');
           
           let appended = false; 
           
           const col9Elements = document.querySelectorAll('.col-9');
           
           col9Elements.forEach(col9Element => {
               if (col9Element.textContent.trim() === "100 DAY MONEY BACK GUARANTEE" && !appended) {
                   const parentCol12 = col9Element.closest('.col-12');
                   console.log('parentCol12 >>>>>>>', parentCol12);
           
                   const siblings = [];
                   let nextSibling = parentCol12.nextElementSibling;
                   while (nextSibling && siblings.length < 3) {
                       if (nextSibling.classList.contains('col-12')) {
                           siblings.push(nextSibling);
                       }
                       nextSibling = nextSibling.nextElementSibling;
                   }
                  const clonedWrapperDiv = wrapperDiv.cloneNode(false);
                  const clonedParentCol12 = parentCol12.cloneNode(true); 

                   clonedWrapperDiv.appendChild(clonedParentCol12);
                   siblings.forEach(sibling => {
                       clonedWrapperDiv.appendChild(sibling);
                   });
                   console.log('parentCol12.nextSibling >>',parentCol12.nextSibling)
                   parentCol12.style.display = "none";
                   parentCol12.parentNode.insertBefore(clonedWrapperDiv, parentCol12.nextSibling);
                   appended = true; 
                   return; 
               }
           });
        ...
        if(sessionStorage.getItem("isRecommendedProductAddedNew") !== null){
            var totalPriceString = document.querySelector('.col-6.mt-3.text-end').textContent.trim(); 
            var totalPriceNumber = parseFloat(totalPriceString.substring(1));
            var formattedPrice  = totalPriceNumber - 34.99; 
            var finalTotalPrice = formattedPrice.toFixed(2);
        }else{
            var finalTotalPrice   = document.querySelector('.col-6.mt-3.text-end').textContent.trim();
        }

        if(finalTotalPrice){
             var newTextOfCheckout = 'Checkout - '  + finalTotalPrice ;
      ...
      // Check if TRTL TRAVEL PILLOW exist 
        ...
        if (element.textContent.includes("TRTL TRAVEL PILLOW")) {
                ...
                if (sessionStorage.getItem("isRecommendedProductAddedNew") !== null) {
                        ...
                        sessionStorage.removeItem("isRecommendedProductAddedNew");
        ...
        //check which special product is added 
        // var trtlPillowelements = document.querySelectorAll('#cart-offcanvas-content .col-12 .col-8 a.text-decoration-none.text-uppercase');

        // trtlPillowelements.forEach(function(element) {
        //     var sessionStorageItem1 = sessionStorage.getItem("isTRTLPillowJunior");
        //     var sessionStorageItem2 = sessionStorage.getItem("isTRTLPillow");
        //     var sessionStorageItem3 = sessionStorage.getItem("isCompressionSocksAdded");
        
        //     if ((sessionStorageItem1 === 'yes' || sessionStorageItem2 === 'yes' || sessionStorageItem3 === 'yes') &&
        //         (element.textContent.trim() === "TRTL PILLOW JUNIOR" || 
        //          element.textContent.trim() === "TRTL TRAVEL PILLOW" || 
        //          element.textContent.trim() === "TRTL COMPRESSION SOCKS")) {
        
        //         var parentElement = element.closest('.cart-items-selector');
        //         var priceDiv = parentElement.querySelector('.line-price');
        //         var priceText = priceDiv.textContent.trim();
        //         var price = parseFloat(priceText.replace('$', ''));
        //         var tenPercent = price * 0.1;
        //         var newPricewithDiscount = (price - tenPercent).toFixed(2);
        
        //         if (sessionStorageItem1 === 'yes' && sessionStorageItem2 === 'yes' && sessionStorageItem3 === 'yes') {
        //             console.log('TRTL PILLOW JUNIOR, TRTL TRAVEL PILLOW, and TRTL COMPRESSION SOCKS are added');
        //             var discountClass = ".custOfferPriceAllItems";
        //             var itemName = "TRTL PILLOW JUNIOR, TRTL TRAVEL PILLOW, and TRTL COMPRESSION SOCKS";
        //         } else if (sessionStorageItem1 === 'yes' && sessionStorageItem2 === 'yes') {
        //             console.log('TRTL PILLOW JUNIOR and TRTL TRAVEL PILLOW are added');
        //             var discountClass = ".custOfferPricePillow";
        //             var itemName = "TRTL PILLOW JUNIOR and TRTL TRAVEL PILLOW";
        //         } else if (sessionStorageItem1 === 'yes' && sessionStorageItem3 === 'yes') {
        //             console.log('TRTL PILLOW JUNIOR and TRTL COMPRESSION SOCKS are added');
        //             var discountClass = ".custOfferPriceJunior";
        //             var itemName = "TRTL PILLOW JUNIOR and TRTL COMPRESSION SOCKS";
        //         } else if (sessionStorageItem2 === 'yes' && sessionStorageItem3 === 'yes') {
        //             console.log('TRTL TRAVEL PILLOW and TRTL COMPRESSION SOCKS are added');
        //             var discountClass = ".custOfferPricePillow";
        //             var itemName = "TRTL TRAVEL PILLOW and TRTL COMPRESSION SOCKS";
        //         } else if (sessionStorageItem1 === 'yes') {
        //             console.log('TRTL PILLOW JUNIOR is added');
        //             var discountClass = ".custOfferPriceJunior";
        //             var itemName = "TRTL PILLOW JUNIOR";
        //         } else if (sessionStorageItem2 === 'yes') {
        //             console.log('TRTL TRAVEL PILLOW is added');
        //             var discountClass = ".custOfferPricePillow";
        //             var itemName = "TRTL TRAVEL PILLOW";
        //         } else if (sessionStorageItem3 === 'yes') {
        //             console.log('TRTL COMPRESSION SOCKS are added');
        //             var discountClass = ".custOfferPriceSocks";
        //             var itemName = "TRTL COMPRESSION SOCKS";
        //         }
        ...
        //     if (document.querySelectorAll(discountClass).length == 0 &&
        //     ((sessionStorageItem1 === 'yes' && element.textContent.trim() === "TRTL PILLOW JUNIOR") ||
        //      (sessionStorageItem2 === 'yes' && element.textContent.trim() === "TRTL TRAVEL PILLOW") ||
        //      (sessionStorageItem3 === 'yes' && element.textContent.trim() === "TRTL COMPRESSION SOCKS"))) {
        
        //     console.log('its same as selected one');
        //     priceDiv.insertAdjacentHTML('beforebegin', '<span class="' + discountClass.replace(".", "") + '">$ ' + newPricewithDiscount + '</span>');


         
        //         var updateTotalPriceString = document.querySelector('.col-6.mt-3.text-end').textContent.trim(); 
        //         var updateTotalPriceNumber = parseFloat(updateTotalPriceString.substring(1));
        //         var updateFormattedPrice  = updateTotalPriceNumber - tenPercent; 
        //         var updateFinalTotalPrice = updateFormattedPrice.toFixed(2);
           
    
        //         if(updateFinalTotalPrice){
        //             var newUpdateTextOfCheckout = 'Checkout - '  + updateFinalTotalPrice ;
        //             document.querySelector('#cart-offcanvas-content a[href="/checkout"]').textContent = newUpdateTextOfCheckout;
        //         }
        //     }
        ...
        //check passport is added after special product added


        // if(sessionStorage.getItem("isPassPortAdded") !== null){
          
        //        //added Free text and remove unwanted div
        //         trtlPillowelements.forEach(function(element) {
        //             if (element.textContent.trim() === "TRTL PASSPORT COVER") {
        //                 var parentElement = element.closest('.cart-items-selector');
        ...
        //                 if (priceDiv) {
        //                     // Add text to the line-price
        //                     priceDiv.textContent = 'Free';
        //                 }
                
        //                 if (priceDiv && priceDiv.closest('.row')) {
        //                     var priceParentDiv = priceDiv.closest('.row');
        //                     console.log("Price parent div:", priceParentDiv);

                            
        //                     var nextpriceParentDiv = priceParentDiv.parentNode;
        //                     // if (nextpriceParentDiv) {
        //                     //   nextpriceParentDiv.style.display = 'none';
        //                     // }
    ...
    btn.addEventListener('click', function() {
        console.log('added custProductsOpen >>>>>>');
    ...
    closeButtons.forEach(function(btn) {
        btn.addEventListener('click', function() {
            console.log('closebutton remove class >>>>>>');
 ...
 var swatchesButtons = document.querySelectorAll('.custCartFollowupWraper .custSwatchWrapper .custSwatchColorPattern');
            ...
            if (strSelectedProdId !== '' && strSelectedProdId !== undefined) {
                ...
                xhr.onload = function() {
                    if (xhr.status === 200) {
                        ...
                        sessionStorage.setItem('isSelectedColor',strSelectedColor);

                        if (Object.keys(arrayColorValue).includes(strSelectedColor)) {
                            // Add sessionStorage entry if selected color is above 4
                            console.log('object    key >>>>>',Object.keys(arrayColorValue).length);
                            if (Object.keys(arrayColorValue).length > 4) {
                                sessionStorage.setItem('isTRTLPillowJunior', 'yes');
                            }else{
                                sessionStorage.setItem('isTRTLPillow', 'yes');
                            }
                        }
    ...
    var cartButtons = document.querySelectorAll('#cart-offcanvas-content button.btn')
    cartButtons.forEach(function(button) {
    button.addEventListener('click', function() {
        console.log('Apply changes again on cart operations:');
        setTimeout(function() {
            var cartButtonsTargetElement = document.querySelector('#cart-offcanvas-content .col-12 .col-8 a.text-decoration-none.text-uppercase');
              if (cartButtonsTargetElement && cartButtonsTargetElement.textContent.includes('TRTL TRAVEL PILLOW')) {
                  addCustGetExtramsgFollowup();
                  addCustomUpSellProduct();
                  modifyExistingCartContent();
              }
   ...
   var arrCompressionSockColorSizeMapping = { "New-York-Small":42424784552129,"New-York-Medium":42424784584897,"New-York-Large": 42424784617665,"Fiji-Small":42424784650433,"Fiji-Medium":42424784683201,"Fiji-Large": 42424784715969,"Kyoto-Small":42424784748737,"Kyoto-Large": 42424784814273,"Havana-Small":42424784847041,"Havana-Medium":42424784879809,"Havana-Large": 42424784912577,"Paris-Small":42424784945345,"Paris-Large": 42424785010881,"Seattle-Small":42424785043649,"Sydney-Small":42424785141953,"Vancouver-Small":42424785240257,"Vancouver-Medium":42424785273025,"Vancouver-Large": 42424785305793,"Jaipur-Small":42424785338561,"Jaipur-Large":42424785404097 }; 
            ...
            // For .custSwatchColorPattern elements
                ...
                if (strSelectedCompressionSockProdId !== '' && strSelectedCompressionSockProdId !== undefined) {
                    ...
                    xhr.onload = function() {
                        if (xhr.status === 200) {
                            sessionStorage.setItem('isRecommendedProductAddedNew', 'yes');
                            sessionStorage.setItem('isCompressionSocksAdded', 'yes');
                            addPassportProduct();
                            // location.reload();
                        }
                    };
        ...
        //check Special Product is added 
          if(sessionStorage.getItem("isRecommendedProductAddedNew") !== null){
                ...
                xhr.onload = function() {
                    if (xhr.status === 200) {
                        document.querySelector('.custPassportCoverBox')?.classList.add('custHideContent');
                        sessionStorage.setItem('isPassPortAdded', 'yes');
                        location.reload();
                    }
                };
                xhr.send(JSON.stringify({
