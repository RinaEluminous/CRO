                ...
                button.addEventListener('click', function() {
                    ...
                    if (specialOfferProductCount == 1) {
                        ...
                        if (document.querySelector('.custRemovebtnPassPort')) {
                            console.log('custRemovebtnPassPort is present');
                            setTimeout(function() {
                                triggerTest();
                    ...
                    if (strSelectedProdId !== '' && strSelectedProdId !== undefined) {
                        ...
                        xhr.onload = function() {
                            if (xhr.status === 200) {
                                ...
                                var isPassportCoverExists = checkProductAvailabilityInMinicart("TRTL PASSPORT COVER");
                                console.log('isPassportCoverExists <<<<<<< ' + isPassportCoverExists);
