...
function updateBundleNavImg() {
    ...
    deskChrisBurkardPillowMenu.forEach(function (element) {
        ...
        if (textElement && textElement.textContent.includes('Includes Free Gift')) {
            ...
            if (imgElement) {
                imgElement.setAttribute('data-src', 'https://trtltravel.com/cdn/shop/files/burkard_lp_pillow_img.png');
                imgElement.setAttribute('data-srcset', 'https://trtltravel.com/cdn/shop/files/burkard_lp_pillow_img.png');
                imgElement.setAttribute('src', 'https://trtltravel.com/cdn/shop/files/burkard_lp_pillow_img.png');
                imgElement.setAttribute('srcset', 'https://trtltravel.com/cdn/shop/files/burkard_lp_pillow_img.png');
    ...
    mobileNavbarLinksElement.forEach(function (listItem) {
        ...
        if (paragraph && paragraph.textContent.includes('Includes Free Gift')) {
            ...
            if (imgElement) {
                imgElement.setAttribute('data-src', 'https://trtltravel.com/cdn/shop/files/chris_burkard_img.png');
                imgElement.setAttribute('data-srcset', 'https://trtltravel.com/cdn/shop/files/chris_burkard_img.png');
                imgElement.setAttribute('src', 'https://trtltravel.com/cdn/shop/files/chris_burkard_img.png');
                imgElement.setAttribute('srcset', 'https://trtltravel.com/cdn/shop/files/chris_burkard_img.png');
                imgElement.setAttribute('alt', 'CHRIS BURKARD X TRTL PILLOW');
...
function addBannerOnCollection() {
    ...
    var collectionBannerHtml = '<div class="custLimitedCollaboration">' +
        ...
        '            <img src="https://trtltravel.com/cdn/shop/files/chris_burkard_img.png" alt="chris_burkard_img">' +
        '        </div>' +
        '    </div>' +
        '</div>';
...
function addSliderOnCollectionNew() {
    ...
    var chrisBarkardProductSliderHtml = '<div class="swiper-slide col-md-3 custProSlider" style="height: auto; width: 418.667px; margin-right: 8px;" data-swiper-slide-index="1">' +
        ...
        '    <div class="custProImg"><img src="https://trtltravel.com/cdn/shop/files/chris_burkard_img.png"></div>' +
