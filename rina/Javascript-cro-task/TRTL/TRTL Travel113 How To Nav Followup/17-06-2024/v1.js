...
var howItWorkHtml = '<li class="nav-item custHowItWorksV1">' +
 '    <a href="/pages/aftercare-travel-pillows" class="nav-link ">How it Works</a>' +
 '</li>';

if (accessoriesTabCount > 0 && document.querySelectorAll('.custHowItWorksV1').length == 0) {
...
var howItWorkTabHtmlMob = '<div class="col-12">' +
 '    <a class="nav-link p-0 fs-3 font-ibm-mono" href="/pages/aftercare-travel-pillows">How it Works</a>' +
 '</div>';
...
if (navBareaderElement) {
 navBareaderElement.classList.add('custDesktopNavBarV1');
}
...
if (rowReverseFlexElement && navPositionStaticElement) {
    ...
    rowReverseFlexElement.classList.add('custFlexReverseV1');
}
