window.onload = function (){
  ...
  addCustomHTMLForHomePageV2();
  }
  };
  
  function addCustomHTMLForHomePageV2(){
  ...
  '        </ul>'+
  '    </section>'+
 '<section class="custHPheaderWraperV2">'+
'    <div class="review">'+
'        <img src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/stars.svg" alt="">'+
'        <p>5000+5-STAR REVIEWS</p>'+
'    </div>'+
'    <h3>your best sleep while traveling</h3>'+
'    <div class="custImgBanner">'+
'       <img src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/hp-slider-img-2.png" alt="">'+
'    </div>'+ 
'    <p>Scientifically proven to help you drift off anywhere, anytime. Effective for all kinds of travel.</p>'+
'    <a href="/collections/all-products" class="custBtnV2 custYellowBtnV2">SHOP NOW</a>'+
'</section>'+  
  '<div class="custPartnersMainV2">'+
  '    <h4 class="custSectionTitleV2"><span class="custBlueV2">OVER 1 MILLION </span> RELAXED <br> TRAVELLER\'S CAN\'T BE WRONG</h4>'+
  ...
  '                        <div class="custProductsCardImg"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/deep-sleep-bundle.jpg" class="img-fluid" alt="Deep Sleep Bundle"><span class="custProductBestSeller custYellowBgV2 custBlackV2">UP TO 41% Off!</span></div>'+
  '                        <div class="custProductsCardText">'+
  ...
  '                <div class="col-lg-6 d-flex justify-content-center"><img class="directional-imgV2" src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/the-ultimate-travel-pillow-experience.png" alt="The Ultimate Travel Pillow Experience!"></div>'+
  '                <div class="col-lg-6">'+
  ...
  '                <div class="col-lg-7">'+
  '                    <div class="custTextWrapper custUnmatchedDeskImgV2">'+
  ...
  '                                </div>'+
  '                            </div>'+
  '                            <div class="custButtonWrapper"><a class="custBtnV2" href="https://trtltravel.com/pages/reviews">Show more</a></div>'+
  '                        </div>'+
  '                    </div>'+
  '                </div>'+
  '            </div>'+
  ...
  '                <div class="col-lg-12">'+
  '                    <div class="custTextWrapper justify-content-start custRiskFreeDeskImgV2">'+
