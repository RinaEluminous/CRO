...
function generateShipingWrapperPDPSection(){
    console.log('generateShipingWrapperPDPSection >>>>>>>>>>>>>');
...
function trtlePillowPDPRedesign(){
    ...
    const shippingWrapperElement = document.querySelector('.custShippingFocusWraper');
    const prodDescElement = document.querySelector('.product-description');
    const featuresElement = document.querySelector('.custFeatures');
    
    if (prodDescElement && shippingWrapperElement) {
        shippingWrapperElement.parentNode.insertBefore(prodDescElement, shippingWrapperElement);
        console.log("Inserted Product Description Element before Shipping Wrapper Element");
    }
    
    if (shippingWrapperElement && featuresElement) {
        shippingWrapperElement.parentNode.insertBefore(featuresElement, shippingWrapperElement.nextSibling);
        console.log("Inserted Features Element after Shipping Wrapper Element");
    }
    ...
    if (partnersMainElement && ultimateFocusTravelElement) {
        ...
        console.log("Inserted Partners Main Element before Ultimate Focus Travel Element");
    }
