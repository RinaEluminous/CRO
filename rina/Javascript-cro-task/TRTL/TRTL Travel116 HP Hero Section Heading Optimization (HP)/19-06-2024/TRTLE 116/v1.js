// window.onload = function (){
  ...
  if(document.querySelectorAll('body.template-index').length > 0 && (window.innerWidth <= 767) ) {
         document.querySelector('body').classList.add('custBody');
      if(document.querySelectorAll('.template-index .section-footer').length > 0) {
          document.querySelector('.template-index .section-footer').classList.add('custFooter');
      }
...
function addCustomHTMLForHomePage(){
  ...
  '        </ul>'+
  '    </section>'+
  '    <section class="custHeroWrapper">'+
  '        <div class="container px-0 custContainer1280">'+
  '            <div class="custHeroWrap">'+
  '                <div class="custHeroWrapText">'+
  '                    <div class="custHeroReview"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/stars.svg" alt="Stars"> 5000+ HAPPY CUSTOMERS</div>'+
  '                    <h2 class="custHeroTitle">STILLNESS AT 35,000 FEET</h2>'+
  '                    <h4 class="custHeroSubTitle">THE MOST COMFORTABLE WAY TO TRAVEL, ANYWHERE</h4><a href="https://trtltravel.com/products/trtl-travel-pillow" class="custBtn custYellowBtn">SHOP NOW</a>'+
  '                </div>'+
  '            </div>'+
  '        </div>'+
  '    </section>'+
  '    <section class="custProductsWrapper">'+
  '        <div class="container px-xxl-0 custContainer1200">'+
  '            <div class="swiper custMySwiper">'+
  '                <div class="custProductsWrap swiper-wrapper">'+
  '<a href="https://trtltravel.com/products/trtl-travel-pillow" class="custProductsCard custHeroIamge swiper-slide swiper-slide-active" data-swiper-slide-index="0" style="width: 239.25px; margin-right: 12px;">'+
'    <div class="custProductsCardImg"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/unmatched-comfort-&-support-desk-3.png" class="img-fluid" alt="Pillow"></div>'+
'    <div class="custProductsCardText">'+
'        <button href="https://trtltravel.com/products/trtl-travel-pillow" class="custBtn custYellowBtn">SHOP NOW</button>'+
'    </div>'+
'</a>'+
  ...
  '                        <div class="custProductsCardImg"><img src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/deep-sleep-bundle.jpg" class="img-fluid" alt="Deep Sleep Bundle"><span class="custProductBestSeller custYellowBg custBlack">UP TO 41% Off!</span></div>'+
  '                        <div class="custProductsCardText">'+
  ...
  '<div class="custPartnersHeadline">'+
  '    <h4 class="custSectionTitle"><span class="custBlue">OVER 1 MILLION </span> RELAXED <br> TRAVELLER\'S CAN\'T BE WRONG</h4>'+
  '</div>'+
'    <div class="container">'+
...
'</div>'+ 
  ...
  '        <div class="container custContainer1280 px-xxl-0">'+
  '            <h2 class="custSectionTitle">The<span class="custBlue"> Ultimate</span> Travel<br> Pillow Experience!</h2>'+
  ...
  '                                </div>'+
  '                            </div>'+
  '                            <div class="custButtonWrapper"><a class="custBtn" href="https://trtltravel.com/pages/reviews">Show more</a></div>'+
  '                        </div>'+
  '                    </div>'+
  '                </div>'+
  '            </div>'+
  ...
  '                <div class="col-lg-12">'+
  '                    <div class="custTextWrapper justify-content-start custRiskFreeDeskImg">'+
  ...
  if(document.querySelectorAll('#MainContent').length > 0 && document.querySelectorAll('.custWrapper').length == 0){
