...
function addNavigationBundleDropdowns(){
    ...
    if(pillowTabCount > 0 && bundlesTabCount == 0) {
       ...
       '                        <div class="row gy-4">'+
       '                            <div class="col-12">'+
       '                                <div class="tile-line-item-menu  custBestSellerHighlightV1">'+
       '                                    <div class="custItemImgBoxV1">'+
       ...
       const navbarLinks = document.querySelectorAll('.section-header nav.navbar ul.navbar-nav li a');
           ...
           navbarLinks.forEach(listItem => {
               ...
               if (listItem.textContent.trim() === 'Reviews') {
                   ...
                   const parentListItem = listItem.parentElement;
                   parentListItem.classList.add('custReviewMenuV1');
    ...
    '            </div>'+
    '            <div class="col-6 mt-2">'+
    '                <div class="tile-product-menu text-center overflow-hidden  custBestSellerHighlightV1">'+
    '                    <div class="row g-0">'+
    '                        <div class="position-relative overflow-hidden col-12 mb-3 " style="width:400px;">'+
    ...
    '                <div class="tile-product-menu text-center overflow-hidden">'+
    '                    <div class="row g-0">'+
    '                        <div class="position-relative overflow-hidden col-12 mb-3 height-medium custMainProductNavV1">'+
   ...
   mobileNavbarLinksElement.forEach(listItem => {
       ...
       if (listItem.textContent.trim() === 'Pillows') {
         ...
         const mobileDoubleComfortBundleParentHTML ='<div class="col-12 mt-2 custMobileBundleHtmlV1">'+
         '    <div class="tile-product-menu text-center overflow-hidden">'+
         '        <div class="row g-0">'+
         '            <div class="position-relative overflow-hidden col-12 mb-3 height-medium custMainProductNavV1">'+
         '                <div id="image-wrapper-43116221235393-b1b11-198916" class="image-cover overflow-hidden">'+
       ...
       if (mobileDoubleBundleElements.length > 2 && document.querySelectorAll('.custMobileBundleHtmlV1').length == 0) {
...
function addCustHtml(){
    ...
    if(window.screen.width > 767){
        ...
        var mobileNavHtml = '<div class="custMobileNavPanel custHideContent">'+
        '    <div class="custMenuHeader"></div>'+
        '    <div class="custMenuBody">'+
        '        <div class="custMenuItems">'+
        '            <div class="custMobileNavPanel">'+
        '                <div class="custMenuHeader">'+
        '                    <div class="backBtn">'+
        ...
        '                        <h4><img src="https://growth-hit.s3.us-west-2.amazonaws.com/trtltravel/trending-icon.svg"> Trending Product</h4>'+
        '                        <div class="tile-line-item-menu custOfferBadge">'+
        '                            <div class="row">'+
        '                                <div class="col-3">'+
        '                                    <div class="image-wrapper overflow-hidden ">'+
        '                                        <picture class=" d-block">'+
        '                                            <img data-src="//trtltravel.com/cdn/shop/files/TPO_Grey_TPO_Grey_Passportcover_400x400_crop_center.jpg?v=1699882173" data-srcset="//trtltravel.com/cdn/shop/files/TPO_Grey_TPO_Grey_Passportcover_400x400_crop_center.jpg?v=1699882173 1x, //trtltravel.com/cdn/shop/files/TPO_Grey_TPO_Grey_Passportcover_400x400_crop_center@2x.jpg?v=1699882173 2x" loading="lazy" class="image-fade img-fluid lazyload loaded" alt="DOUBLE COMFORT BUNDLE + FREE GIFT" src="//trtltravel.com/cdn/shop/files/TPO_Grey_TPO_Grey_Passportcover_400x400_crop_center.jpg?v=1699882173" srcset="//trtltravel.com/cdn/shop/files/TPO_Grey_TPO_Grey_Passportcover_400x400_crop_center.jpg?v=1699882173 1x, //trtltravel.com/cdn/shop/files/TPO_Grey_TPO_Grey_Passportcover_400x400_crop_center@2x.jpg?v=1699882173 2x">'+
        '                                        </picture>'+
        '                                    </div>'+
        '                                </div>'+
        '                                <div class=" col-9 ">'+
        ...
        '                                            <h5 class="m-0 fw-bolder text-md-uppercase d-flex position-relative">'+
        '                                                DOUBLE COMFORT BUNDLE'+
        '                                                <a href="/products/double-comfort-bundle-free-gift" class="stretched-link" aria-label="DOUBLE COMFORT BUNDLE"></a>'+
        '                                            </h5>'+
        '                                            <div class="ms-auto product-flashtags-container d-flex justify-content-center align-items-start position-relative">'+
        ...
        if (mobNavElement && !document.querySelector('.custMobileNavPanel')) {
    ...
    mobNavbarLinks.forEach(listItem => {
        if (listItem.textContent.trim().includes('Pillows')) {
          listItem.addEventListener('click', function(event) {
            const mobNavPanelElement = document.querySelector('.custMobileNavPanel');
            mobNavPanelElement?.classList.add('custShowContent');
            mobNavPanelElement?.classList.remove('custHideContent');       
            console.log("Pillows link clicked");
             //remove all active tab
             document.querySelectorAll('.menuTab').forEach(tab => tab.classList.remove('active'));
             document.querySelectorAll('.custNavItems').forEach(menu => menu.classList.add('custHideContent'));
             document.querySelectorAll('.custNavItems').forEach(menu => menu.classList.remove('custShowContent'));
             
             // add active class to accessories tab
             document.querySelector('.menuTab[data-name="pillows"]').classList.add('active');
             document.getElementById('pillowsMenu').classList.add('custShowContent');
          ...
          listItem.addEventListener('click', function(event) {
            ...
            console.log("Accessories link clicked");
            //remove all active tab
            document.querySelectorAll('.menuTab').forEach(tab => tab.classList.remove('active'));
            document.querySelectorAll('.custNavItems').forEach(menu => menu.classList.add('custHideContent'));
            document.querySelectorAll('.custNavItems').forEach(menu => menu.classList.remove('custShowContent'));
            ...
            document.getElementById('accessoriesMenu').classList.add('custShowContent');
          ...
          listItem.addEventListener('click', function(event) {
            ...
            mobNavPanelElement?.classList.add('custShowContent');
            mobNavPanelElement?.classList.remove('custHideContent'); 
            console.log("Bundles link clicked");
             ...
             document.getElementById('bundlesMenu').classList.add('custShowContent');
          });
        }
      });
    ...
    document.querySelectorAll('.menuTab').forEach(tab => {
        tab.addEventListener('click', () => {
         ...
         let menuId = tab.getAttribute('data-name');
          ...
          document.getElementById(menuId + 'Menu').classList.add('custShowContent');
      ...
      const cancelbuttons = document.querySelectorAll('.custMenuHeader .backBtn, .offcanvas-header button');
      cancelbuttons.forEach(button => {
        button.addEventListener('click', () => {
          console.log('Button clicked');
          const mobNavPanelElement = document.querySelector('.custMobileNavPanel');
          mobNavPanelElement?.classList.add('custHideContent');
          mobNavPanelElement?.classList.remove('custShowContent');
        });
      });
