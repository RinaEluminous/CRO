    ...
    liElements.forEach(function (li) {
        ...
        if (label) {
            setTimeout(function () {
                ...
                // console.log('colorOptionData >>>',colorOptionData);
               
                // console.log('custClassName >>>',custClassName);
        ...
        button.addEventListener('click', function () {
            ...
            setTimeout(function () {
               ...
               // console.log(button);
                ...
                console.log('colorLabelText:', colorLabelText);
                // var nameColor = labelElement.getAttribute('for');
