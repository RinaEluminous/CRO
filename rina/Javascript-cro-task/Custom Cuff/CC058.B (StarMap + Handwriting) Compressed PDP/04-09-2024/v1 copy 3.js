...
'            <span class="custTabReadMoreBtn">Read less</span>'+
'        </div>'+
  ...
  if (showMoreBtn) {
    showMoreBtn.addEventListener('click', () => {
      ...
      if (flickityViewPortElement) {
        ...
        //console.log('Toggled class>> ', flickityViewPortElement.classList);
  ...
  readMoreBtns.forEach(function (readMoreBtn) {
    readMoreBtn.addEventListener('click', function () {
      ...
      var readMoreContent = readMoreBtn.closest('.active');
        ...
        var readMoreText = readMoreBtn.querySelector('.custTabReadMoreBtn');
...
/* Premium gift box click */
 ...
 var giftBoxOptions = document.querySelectorAll('.giftBoxOption');
