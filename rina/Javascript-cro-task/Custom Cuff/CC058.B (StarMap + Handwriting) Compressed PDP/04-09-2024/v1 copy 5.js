    ...
    if(label.textContent.includes('FINISH:')){
      ...
      if (sizeSwatchList) {
       sizeSwatchList.classList.add('custFinishUlElement');
        console.log('Class added to the SizeSwatchList');
      }
    }
...
//   }
//   // firstAddToCartButton.querySelector('span').textContent='Add to cart -' +intActualPrice;
//   addToCartButtons.forEach(function(button){
//     button.closest('span').textContent='Add to cart -' +intActualPrice;
//   });
...
console.log('intActualPrice>>',intActualPrice);
console.log('intActualPrice>>',intCancelPrice);
 ...
 var contents = document.querySelectorAll('.custTabContentItem');
  ...
  if (showMoreBtn) {
    showMoreBtn.addEventListener('click', () => {
      console.log('main slider show more clicked <<<<<<<<<<');
      ...
      if (flickityViewPortElement) {
        ...
        console.error('flickityViewPortElement not found');
      }
    });
  } else {
    console.error('.custShowMoreBtn not found');
  }
  ...
  readMoreBtns.forEach(function (readMoreBtn) {
    readMoreBtn.addEventListener('click', function () {
      console.log('read more/less for tab');
...
sizeSwatchElement.forEach(function(swatch){
  swatch.addEventListener('click', function(){
    console.log('swatch click working >>>>')
    compressedPDPOfStarMapHandwriting();
    addStickyFooterOnPdp();
    setTimeout(function(){
      var checkedInputElement = document.querySelector('.SizeSwatchList input[type="radio"]:checked');
      ...
      // console.log('intProductPrice >>>>',intProductPrice);
...
//       console.log('Premium gift box click >>');
//         if (this.value === 'premium') {
//            console.log('Premium gift box click >>');
//           //for star map products click
//            var labelElements = document.querySelectorAll('label.container');
//            if(labelElements){
//             labelElements.forEach(function(labelElement) {
//               if (labelElement.textContent.includes("ADD PREMIUM GIFT BOX")) {
//                 var checkboxElement = labelElement.querySelector('input[type="checkbox"]');
//                 if (checkboxElement) {
//                   console.log('ADD PREMIUM GIFTBOX <<<<');
//                   checkboxElement.click();
//                   } 
//               }
//             });
//            }
//         //for handwriting products click

//         var labelContentElements = document.querySelectorAll('.gpo-label .label-content');
//         labelContentElements.forEach(function(labelElement) {
...
giftBoxOptions.forEach(function(option) {
    option.addEventListener('click', function() {
        ...
        if (selectedValue === 'premium') {
                   ...
                   var checkboxElement = labelElement.closest('.gpo-element').querySelector('input[type="checkbox"]');
                    if (checkboxElement) {
                        ...
                        if (premiumPriceElement) {
                          premiumPriceElement.style.display = 'block';
                        }
            ...
            labelContentElements.forEach(function(labelElement) {
                if (labelElement.textContent.includes("ADD PREMIUM GIFT BOX")) {
                  console.log('ADD PREMIUM GIFT BOX >>>');
                    var checkboxElement = document.querySelector('.gpo-choicelist.gpo-checkbox input[name="ADD GIFTBOX"][value="YES"]');
                    if (checkboxElement) {
                        console.log('Clicking ADD PREMIUM GIFT BOX checkbox');
                        checkboxElement.click();
                        ...
                        var PremiumGiftValue = document.querySelector('.custPremiumGiftValue');
                        if (PremiumGiftValue) {
                          PremiumGiftValue.textContent = premiumGiftValue;
                        }
