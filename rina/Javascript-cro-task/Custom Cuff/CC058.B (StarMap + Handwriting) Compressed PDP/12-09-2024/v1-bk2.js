...
function addToCartUpdatePrice(){
     //update price at add to cart 
    
     var currentPath = window.location.pathname;
     if (currentPath.includes("/products/custom-star-map-ring")) {
      var addToCartButtons = document.querySelectorAll('#starmap-complete');
    }else{
      ...
      option.addEventListener('click', function (e) {
        ...
        if (selectedValue === 'premium') {
          ...
          labelElements.forEach(function (labelElement) {
            if (labelElement.textContent.includes("ADD PREMIUM GIFTBOX") || labelElement.textContent.includes("ADD GIFTBOX")) {
