...
function addHeaderBanner() {
    ...
    var interval = setInterval(() => {
      ...
      if (barElement) {
        barElement.innerHTML = '<span class="custDaySaleheading">Memorial Day Sale! </span> Save up to 50%! &nbsp;&nbsp;&nbsp;&ndash;&nbsp;&nbsp;&nbsp; <span class="custTimerContainer">Ends in <span class="custTimer">' + hours + ':' + minutes + ':' + seconds + '</span></span>';
      }
...
var pdpBannerHtml ='<div class="custmaySaleEventTopBanner">'+
  ...
  '        <a href="https://www.myvidaorigins.com/products/daily-focus">'+
